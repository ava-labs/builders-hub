  ...
  useEffect(() => {
    ...
    const onChainChanged = async (chainId: string | number) => {
      ...
      try {
        ...
        // Ignore errors when fetching chain info
      }
      ...
      try {
        ...
        // Ignore errors when updating balances
      }
    };
    ...
    const handleAccountsChanged = async (accounts: string[]) => {
      ...
      try {
        const [pAddr, cAddr, chainInfo, chainId] = await Promise.all([
          ...
          client
            .getEthereumChain()
            .catch(() => ({ isTestnet: undefined as any, chainName: "" }) as any),
        ...
        // Ignore errors when fetching wallet information
      }
    ...
    try {
      ...
      // Ignore errors when setting up event listeners
    }
