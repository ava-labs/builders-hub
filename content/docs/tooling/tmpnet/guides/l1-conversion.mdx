...
> The code snippets in this guide mirror the helpers used in `icm-services` (for example `icm-contracts/tests/network`); they assume shared utilities for genesis creation, contract bindings, and Warp signing. Use them as patterns and refer to the source files for runnable implementations.
...
<Cards>
  ...
  <Card title="PoA Management" href="/docs/tooling/tmpnet/guides/validator-management-poa">
