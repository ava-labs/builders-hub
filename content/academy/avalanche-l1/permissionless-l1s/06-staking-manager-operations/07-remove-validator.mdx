...
The validator owner calls [`initiateValidatorRemoval(validationID)`](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/StakingManager.sol) on the Staking Manager contract.
...
Call [`completeValidatorRemoval(messageIndex)`](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L573) with the P-Chain's signed response:
