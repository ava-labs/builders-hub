  ...
  return (
    <div className="space-y-4">
      ...
      <Input
        ...
        label="New Weight"
        disabled={isProcessing || !subnetId || isContractOwner === false}
      ...
      {isContractOwner === false && !error && !txSuccess && (
         <div className="p-3 rounded-md bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm">
            <div className="flex items-center">
              <AlertCircle className="h-4 w-4 text-red-500 mr-2 flex-shrink-0" />
              <span>You are not the owner of this Validator Manager contract. Only the owner can perform this action.</span>
            </div>
          </div>
      )}
