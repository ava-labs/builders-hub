...
import {
  ...
  IncreaseL1ValidatorBalanceParams,
} from "./methods/increaseL1ValidatorBalance";
import {
...
export type CoreWalletClientType = Omit<AvalancheWalletClient, "addChain"> & {
  ...
  extractWarpMessageFromPChainTx: (
    args: ExtractWarpMessageFromTxParams
...
export async function createCoreWalletClient(
  ...
  const clientWithCustomMethods = {
    ...
    setL1ValidatorWeight: (args: SetL1ValidatorWeightParams) =>
      setL1ValidatorWeight(baseClient, args),
