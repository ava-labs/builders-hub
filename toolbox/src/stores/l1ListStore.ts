    ...
    l1List: [
        {
            ...
            name: "C-Chain",
            description: "The C-Chain of the Avalanche Fuji Testnet is the EVM chain of the Primary Network of the Testnet.",
        ...
        },
        {
            ...
            name: "Echo",
            description: "Echo is a testnet L1 for testing dApps utilizing Interchain Messaging.",
        ...
        },
        {
            ...
            name: "Dispatch",
            description: "Dispatch is a testnet Subnet for testing dApps utilizing Interchain Messaging.",
