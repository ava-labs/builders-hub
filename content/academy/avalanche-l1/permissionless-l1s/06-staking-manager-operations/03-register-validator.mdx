...
The validator calls [`initiateValidatorRegistration`](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/NativeTokenStakingManager.sol) on the Staking Manager contract.
...
Call [`completeValidatorRegistration(messageIndex)`](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L425) with the P-Chain's signed response:
