      ...
      <section className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-4xl">
          ...
          <p className="text-lg text-foreground mb-12 max-w-3xl mx-auto">
            A comprehensive suite of React components designed for modern web applications. Build
            beautiful, accessible, and performant user interfaces with our type-safe and
