    ...
    return (
      <div className="flex items-center justify-center min-h-[400px] p-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-zinc-600 dark:text-zinc-400">Checking {precompileName} availability...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px] p-8">
        <div className="max-w-md w-full text-center">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-2">Connection Error</h3>
      ...
      <div className="flex items-center justify-center min-h-[400px] p-8">
        <div className="max-w-lg w-full text-center">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl p-4 mb-6 text-left">
            <h4 className="text-sm font-medium text-zinc-900 dark:text-zinc-100 mb-2">What you can do:</h4>
