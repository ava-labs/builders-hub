...
- [Validator-only communication to create a private Avalanche L1](/docs/avalanche-l1s/evm-configuration/avalanche-l1-configs#validatoronly-bool)
- [Consensus](/docs/avalanche-l1s/evm-configuration/avalanche-l1-configs#consensus-parameters)
- [Gossip](/docs/avalanche-l1s/evm-configuration/avalanche-l1-configs#gossip-configs)

See [here](/docs/avalanche-l1s/evm-configuration/avalanche-l1-configs) for more info.
