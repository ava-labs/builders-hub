...
const Modal: React.FC<{ isOpen: boolean; onClose: () => void; track: PartnerTrack }> = ({
  isOpen,
  onClose,
  track,
}) => {
  ...
  const partnerTracks: PartnerTrack[] = [
    {
      ...
      description:
        "Two tracks focused on Chainlink enabled Avalanche L1s and On-chain Finance on Avalanche. Leverage Chainlink's powerful oracle network to build innovative solutions on Avalanche.",
      tracks: [
        {
          name: "1: Chainlink-enabled Avalanche L1s",
          bounty: "$10,000 ($2,000 to the 5 best projects)",
          description:
            "Build a decentralized application on an Avalanche L1 that makes use of a Chainlink service on Fuji, which is then brought onto the L1 using Avalanche Teleporter. Explore the possibilities of cross-chain communication and data transfer using Chainlink's advanced protocols.",
          examples: [
