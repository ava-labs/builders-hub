...
export default function AvaxTokenView({ data, cChainFees, icmFees }: Props) {
  ...
  const metrics = useMemo(() => {
    ...
    return [
      ...
      {
        label: "Total Burned",
        value: formatNumber(burnedTotal),
        fullValue: formatFullNumber(burnedTotal),
        icon: Flame,
        subtext:
          data.price > 0
            ? formatUSD(burnedTotal)
            : `${calculatePercentage(burnedTotal.toString(), data.totalSupply)}% of genesis supply`,
        subtextTooltip: data.price > 0 ? "at current prices" : undefined,
        color: "#F59E0B",
        tooltip: "Total AVAX burned across P-Chain, C-Chain, and X-Chain",
      },
    ];
  }, [data, actualTotalSupply]);
    ...
    return [
      {
        ...
        percentage: parseFloat(calculatePercentage(data.totalCBurned, burnedTotal)),
        color: "bg-[#E84142]",
      ...
      },
      {
        ...
        percentage: parseFloat(calculatePercentage(data.totalPBurned, burnedTotal)),
        color: "bg-[#3752AC]",
      ...
      },
      {
        ...
        percentage: parseFloat(calculatePercentage(data.totalXBurned, burnedTotal)),
        color: "bg-[#10B981]",
                  ...
                  <div className="pt-3 mt-3 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-bold font-mono text-black dark:text-white">
                        {formatFullNumber(parseFloat(data.totalPBurned) + parseFloat(data.totalCBurned) + parseFloat(data.totalXBurned))}{" "}AVAX
                      </span>
                    </div>
                  </div>
                </div>
