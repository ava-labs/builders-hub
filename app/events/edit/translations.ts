export const t = {
  en: {
    ...
    techStackOptions: 'Tech Stack Options',
    techStackOptionsHelp: 'Comma-separated list of tech-stack tokens shown in the submission multi-select (e.g. Frontend, Backend, Smart Contract, AI/ML).',
    ...
    teamPartnerEnabled: 'Enable Solo/Duo Partner Picker',
    teamPartnerEnabledHelp: 'When on, the registration form asks the participant to pick Solo or Duo, and to invite a teammate if Duo.',
  ...
  es: {
    ...
    techStackOptions: 'Opciones de Stack Tecnológico',
    techStackOptionsHelp: 'Lista separada por comas de tokens de stack tecnológico (p. ej. Frontend, Backend, Smart Contract, AI/ML).',
    ...
    teamPartnerEnabled: 'Habilitar selector Solo/Duo',
    teamPartnerEnabledHelp: 'Cuando está activado, el formulario de registro pregunta si el participante va Solo o en Duo, e invita a un compañero si es Duo.',
