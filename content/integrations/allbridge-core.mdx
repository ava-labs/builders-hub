...
For more details, visit the [Allbridge Core Documentation](https://docs-core.allbridge.io/sdk/get-started)
...
2. **User Onboarding**:
    The optional gas top-up reduces barriers to entry into the Avalanche ecosystem.
