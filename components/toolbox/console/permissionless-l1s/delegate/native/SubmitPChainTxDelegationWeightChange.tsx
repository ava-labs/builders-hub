...
const SubmitPChainTxDelegationWeightChange: React.FC<SubmitPChainTxDelegationWeightChangeProps> = ({
    subnetIdL1,
    initialEvmTxHash,
    signingSubnetId,
    onSuccess,
    ...
    return (
        <div className="space-y-4">
            <Input
                label="initiateDelegatorRegistration Transaction Hash"
                value={evmTxHash}
                onChange={handleTxHashChange}
                placeholder="Enter the initiateDelegatorRegistration transaction hash from step 3 (0x...)"
