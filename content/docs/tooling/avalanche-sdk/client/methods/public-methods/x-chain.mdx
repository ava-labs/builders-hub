...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetbalance)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetallbalances)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetassetdescription)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetheight)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetblockbyheight)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetblock)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgettx)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgettxstatus)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgettxfee)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetutxos)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmissuetx)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmbuildgenesis)
