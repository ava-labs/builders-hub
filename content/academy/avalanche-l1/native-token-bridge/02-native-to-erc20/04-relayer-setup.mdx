---
title: Relayer Setup
description: Set up a hosted ICM relayer between your L1 and Fuji C-Chain.
updated: 2025-12-17
...
Token bridging uses Interchain Messaging (ICM) under the hood, so you need a relayer between your **L1** and **Fuji C-Chain** to deliver cross-chain messages.
