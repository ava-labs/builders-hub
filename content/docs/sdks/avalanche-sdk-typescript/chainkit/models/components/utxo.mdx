---
title: "Utxo"
description: "Chainkit SDK documentation for utxo"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/utxo.md
---
...
| `asset`                                                                               | [components.AssetAmount](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/assetamount.md)                      | :heavy_check_mark:                                                                    | N/A                                                                                   |                                                                                       |
...
| `credentials`                                                                         | [components.UtxoCredential](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/utxocredential.md)[]              | :heavy_minus_sign:                                                                    | Credentials that signed the transaction to consume this utxo                          |                                                                                       |
