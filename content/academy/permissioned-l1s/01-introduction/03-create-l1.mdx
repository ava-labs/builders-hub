...
First, ensure you have Core wallet installed and funded with testnet AVAX on the P-Chain. Core is the only wallet that supports P-Chain transactions, which you will need for this course.
