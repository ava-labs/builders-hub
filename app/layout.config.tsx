  ...
  items: [
    {
      icon: <Wallet />,
      text: "Wallet SDKs",
      description: "Explore solutions for implementing wallet SDKs in your dApps.",
  ...
  items: [
    {
      ...
      description: "Create and customize multiple charts with real-time chain metrics.",
    },
    {
      icon: <Logs />,
      text: "Avalanche L1s",
      url: "/stats/overview",
      description: "View the latest metrics for all Avalanche L1s in the network.",
      menu: {
    ...
    },
    {
      ...
      description: "View the latest metrics for the Avalanche C-Chain.",
      menu: {
        className: "lg:col-start-2 lg:row-start-2",
      },
    },
    {
      ...
      description: "View the latest metrics for the Avalanche Primary Network validators.",
      menu: {
      ...
      menu: {
        banner: (
          <div className="-mx-3 -mt-3">
            <Image
              src={
                "https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/course-banner/avalanche-fundamentals-skz9GZ84gSJ7MPvkSrbiNlnK5F7suB.jpg"
              }
              alt="Preview"
              width={900}
              height={400}
      ...
      menu: {
        banner: (
          <div className="-mx-3 -mt-3">
            <Image
              src={
                "https://qizat5l3bwvomkny.public.blob.vercel-storage.com/Codebase-Entrepreneur-Academy-banner.png"
              }
...
export const consoleMenu: LinkItemType = {
  ...
  items: [
    ...
    },
    {
      ...
      description: "Set up cross-L1 bridges using the Interchain Token Transfer protocol.",
      ...
      menu: {
        banner: (
          <div className="-mx-3 -mt-3">
            <Image
              src={
                "https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/nav-banner/codebase-banner-VKmQyN5sPojnIOU09p0lCkUgR6YTpQ.png"
              }
              alt="Preview"
              width={900}
              height={400}
      ...
      menu: {
        banner: (
          <div className="-mx-3 -mt-3">
            <Image
              src={
                "https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/nav-banner/hackathons-banner-nyqtkzooc3tJ4qcLjfLJijXz6uJ6oH.png"
              }
              alt="Preview"
              width={900}
              height={400}
