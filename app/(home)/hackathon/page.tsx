...
const Modal: React.FC<{ isOpen: boolean; onClose: () => void; track: Track }> = ({
  isOpen,
  onClose,
  track,
}) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white dark:bg-gray-800 z-10 flex justify-between items-center p-6 border-b dark:border-gray-700">
          <div className="flex items-center">
            {track.icon}
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 ml-3">
              {track.title}
            </h2>
          </div>
...
const Section: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
  <div className="mb-6">
    <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-200 border-b pb-2 dark:border-gray-700">
      {title}
    </h3>
    {children}
  </div>
      ...
      >
        ...
        <div className="p-6 grow">
          <div className="flex items-center mb-4">
            <div className={`p-2 rounded-full ${track.color} bg-opacity-20 mr-3`}>{track.icon}</div>
          ...
          <Badge className={`mb-2 ${badgeColors[track.difficulty]}`}>{track.difficulty}</Badge>
        </div>
      </div>
  ...
  const tracks: Track[] = [
    {
      ...
      description:
        "Develop solutions for staking management contracts, on-chain governance, membership platforms, and validator node group management.",
      difficulty: "Advanced",
      ...
      resources: [
        { name: "Avalanche Validator Guide", url: "https://build.avax.network/docs/nodes" },
        {
          ...
          url: "https://github.com/ava-labs/icm-contracts/tree/main/contracts/governance",
        },
      ],
    },
    {
      ...
      description:
        "Customize the execution layer of your blockchain by enhancing the EVM or creating dedicated virtual machines for specific functionalities, optimizing resource usage, and increasing TPS.",
      difficulty: "Advanced",
    ...
    },
    {
      ...
      description:
        "Develop cross-chain decentralized applications on your own customizable L1 that seamlessly interacts with multiple blockchain networks using ICM and ICTT.",
      ...
      resources: [
        ...
        },
        {
          ...
          url: "https://build.avax.network/docs/build/avalanchego/cross-chain",
        },
      ],
    },
    {
      ...
      description:
        "Leverage Avalanche's technology by creating developer tools that simplify building and deploying applications on Avalanche.",
      difficulty: "Intermediate",
    ...
    },
    {
      ...
      description:
        "Develop intelligent AI agents that interact with the Avalanche blockchain to automate tasks, analyze data, and enhance user experiences within decentralized ecosystems.",
      difficulty: "Advanced",
      color: "border-red-500 text-red-700",
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto w-full lg:mx-0">
            <div className="relative mx-auto h-32 w-full max-w-md">
              <Image
                src="https://qizat5l3bwvomkny.public.blob.vercel-storage.com/builders-hub/hackathon-images/AvalancheSummit_London_HackathonLogo_Blue-LGHoUkeODPaagguBk0Fe1MM2ZbOBc9.png"
                alt="Summit London Logo"
                fill
                className="object-contain"
              />
            </div>
            <p className="mt-12 text-center text-lg leading-8 text-muted-foreground">
              At Avalanche, we believe in the power of technology to transform industries and solve
              real-world problems. This hackathon aims to harness the potential of Avalanche&apos;s
              robust technology stack to address pressing issues and create scalable, practical
              solutions.
            </p>
            <div className="mt-8 text-center">
              ...
              <p className="text-lg font-semibold">
                Location:{" "}
                <a
                  href="https://www.google.com/maps/search/?api=1&query=Second%20Home%20Spitalfields&query_place_id=ChIJrWaBB7YcdkgRw6Fv--wBXIU"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-500 hover:underline"
                >
                  Second Home Spitalfields London, England 🇬🇧
                </a>
              </p>
            </div>
          </div>
          <div
            className="flex items-center max-w-xl p-4 mx-auto mt-4 text-sm rounded-lg group"
          ...
          <Card className="bg-linear-to-r from-yellow-100 to-yellow-200 dark:from-yellow-800 dark:to-yellow-900">
            <div className="p-8 text-center">
              ...
              <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">
                Distributed across all tracks based on project impact and innovation. (Plus
                partner&apos;s prizes).
              </p>
              <div className="mb-6">
      ...
      */}
      ...
      <div className="py-12 sm:py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Are you a project looking for developers to test your product and enhance the Avalanche
            Ecosystem?{" "}
            <Link href="https://share.hsforms.com/1kflciOGOQuCDSGGMWdpWSw4h8ew" passHref>
              <strong className="text-yellow-500 hover:underline">Apply as Sponsor</strong>
            </Link>
            , and get your own hackathon track!
          </p>
        </div>
      </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card>
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  The DevRel team at Ava Labs will be available to guide teams on various
                  technologies throughout the hackathon.
                </p>
              </div>
            </Card>
            <Card>
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Attend hands-on workshops on Avalanche technologies, cross-chain communication,
                  blockchain customization, and data visualization.
                </p>
              </div>
            </Card>
            <Card>
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                  ...
                  <li>
                    <Link
                      href="https://academy.avax.network"
                      className="flex items-center text-blue-600 dark:text-blue-400 hover:underline"
                    >
                      Avalanche Academy
                    </Link>
