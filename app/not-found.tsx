...
function findNearestAvailablePath(pathname: string): string | null {
  ...
  const sections = ["/console", "/docs", "/academy", "/blog", "/grants", "/integrations"];
      ...
      <div className="min-h-[calc(100vh-180px)] flex items-center justify-center px-4 sm:px-6 py-8 md:py-12">
        <div className="w-full max-w-5xl mx-auto">
          ...
          >
            ...
            {/* Heading */}
            <div
              className={`space-y-4 mb-8 transition-all duration-500 delay-150 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
            >
            ...
            {currentPath && (
              <div
                className={`mb-8 transition-all duration-500 delay-200 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
              >
            ...
            {suggestedPath && suggestedPath !== currentPath && (
              <div
                className={`mb-8 transition-all duration-500 delay-250 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
              >
                <Link
                  href={suggestedPath}
            ...
            {/* Primary Actions */}
            <div
              className={`flex flex-col sm:flex-row items-center justify-center gap-3 mb-12 transition-all duration-500 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
            >
              <Link href="/">
                <Button
                  size="lg"
            ...
            {/* Quick Links */}
            <div
              className={`transition-all duration-500 delay-400 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
            >
