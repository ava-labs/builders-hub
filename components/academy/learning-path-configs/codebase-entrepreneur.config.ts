...
export const entrepreneurLearningPaths: CourseNode[] = [
    // Foundation Layer
    {
        ...
        slug: "avalanche-entrepreneur/foundations-web3-venture",
    ...
    // Second Layer  
    {
        ...
        slug: "avalanche-entrepreneur/go-to-market",
    ...
    },
    {
        ...
        slug: "avalanche-entrepreneur/web3-community-architect",
        category: "Community",
        dependencies: ["codebase-foundation"],
        position: { x: 70, y: 200 },
        mobileOrder: 3
    ...
    // Third Layer
    {
        ...
        slug: "avalanche-entrepreneur/fundraising-finance",
        category: "Finance",
