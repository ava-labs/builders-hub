...
export const FormSchema = z
  .object({
    ...
    tech_stack: z.string().min(30, { message: "tech stack must be at least 30 characters" }),
    ...
    github_repository: z.preprocess(
      ...
      z
        .array(z.string().min(1, { message: "GitHub repository is required" }))
            ...
            throw new z.ZodError([
              {
                code: "custom",
                message:
                  "Please enter a valid GitHub URL (e.g., https://github.com/username/repo) or username/repo format",
    ...
    demo_link: z.preprocess(
      ...
      z
        .array(z.string().min(1, { message: "Demo link cannot be empty" }))
