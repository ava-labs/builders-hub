...
export default function SelectL1DelegationNativeStep() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        <div className="space-y-4">
          <p className="text-sm text-gray-500 mb-4">
            Choose the L1 subnet where you want to remove a delegation using Native Token staking.
          </p>
          <SelectSubnetId
      ...
      {store.subnetIdL1 && (
        <div className="space-y-4">
          ...
          {validatorManagerDetails.ownerType && validatorManagerDetails.ownerType !== 'StakingManager' && (
            <Alert variant="error">
              This L1 is not using a Staking Manager. This tool is only for L1s with Native Token Staking Managers that
              support delegation.
            </Alert>
          )}
