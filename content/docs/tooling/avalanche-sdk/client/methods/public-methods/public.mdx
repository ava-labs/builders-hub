...
- [API Reference](https://build.avax.network/docs/api-reference/c-chain/api#eth_basefee)
...
- [API Reference](https://build.avax.network/docs/api-reference/c-chain/api#eth_maxpriorityfeepergas)
...
- [API Reference](https://build.avax.network/docs/api-reference/subnet-evm-api#eth_feeconfig)
- [baseFee](#basefee) - Get base fee
...
- [API Reference](https://build.avax.network/docs/api-reference/c-chain/api#eth_getchainconfig)
...
- [API Reference](https://build.avax.network/docs/api-reference/subnet-evm-api#eth_getactiverulesat)
