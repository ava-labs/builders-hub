...
least 48 hours (2 weeks before the [Helicon](/docs/primary-network/helicon-upgrade) upgrade), the delegation fee rate is at least 2%, and you're staking at
least 2,000 AVAX on Mainnet (1 AVAX on Fuji Testnet). A full guide about this can be found
[here](https://support.core.app/en/articles/8117267-core-web-how-do-i-validate-in-core-stake).
...
| `--duration` | Validation duration (min `48h` post-[Helicon](/docs/primary-network/helicon-upgrade); `336h` = 14 days before it) |
