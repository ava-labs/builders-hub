...
const DelegateNative: React.FC<BaseConsoleToolProps> = ({ onSuccess }) => {
        ...
        <>
            <div className="space-y-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-2 border-blue-500">
                    <div className="font-semibold text-sm mb-1">Native Token Delegation</div>
                    <div className="text-xs text-zinc-600 dark:text-zinc-400">
                        You are delegating L1 native tokens
                    </div>
                </div>
                ...
                <Steps>
                    <Step>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            Choose the L1 subnet where you want to delegate Native Tokens to a validator.
                        </p>
                    ...
                    <Step>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            Lock your native tokens to delegate to the selected validator.
                        </p>
