...
|-------------|------|-------------|
| Archival state | ~250 GB/month | Complete history stored at every block |
| Active state + snapshots | ~100 GB/month | Active state + Snapshots every 4000 blocks for serving peers |
| Active state | ~20 GB/month | Current blockchain state only |
