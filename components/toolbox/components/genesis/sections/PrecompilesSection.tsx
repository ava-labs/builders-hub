  ...
  return (
    <SectionWrapper
      ...
      description={
        compact
          ? ""
          : "Enable and configure optional precompiles for permissioning and dynamic parameters."
      }
                  ...
                  <TooltipContent className="max-w-xs">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs font-mono">
                        {precompileInfo.contractDeployer.address}
                      </div>
                ...
                onCheckedChange={(c) => {
                  ...
                  setDeployerConfig((prev) => {
                    ...
                    if (
                      isEnabled &&
                      walletAddress &&
                      (!prev.addresses?.Admin || prev.addresses.Admin.length === 0)
                    ) {
                      newConfig.addresses = {
              ...
              <div className="mt-2">
                <AllowlistPrecompileConfigurator
                  ...
                  description={
                    compact
                      ? ""
                      : "Configure Admin, Manager, and Enabled roles for contract deployment permissions."
                  }
              ...
              <div className="mt-2">
                <AllowlistPrecompileConfigurator
                  ...
                  description={
                    compact
                      ? ""
                      : "Set Admin, Manager, and Enabled roles to control transaction submission rights."
                  }
              ...
              <div className="mt-2">
                <AllowlistPrecompileConfigurator
                  ...
                  description={
                    compact
                      ? ""
                      : "Assign Admin, Manager, and Enabled roles for native token minting authority."
                  }
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs font-mono">
                        {precompileInfo.rewardManager.address}
                      </div>
