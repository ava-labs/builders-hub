  ...
  "Validator Manager Setup": [
    {
      ...
      component: lazy(
        () => import("./ValidatorManager/DeployValidatorMessages")
      ),
      fileNames: [
    ...
    },
    {
      ...
      component: lazy(
        () => import("./ValidatorManager/DeployValidatorManager")
      ),
      fileNames: [
...
export default function ToolboxApp() {
  ...
  return (
    <div className="container mx-auto flex flex-col md:flex-row">
        ...
        <ul className="space-y-6">
          {Object.entries(componentGroups).map(([groupName, components]) => (
            <li key={groupName}>
              ...
              >
                <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200">
                  {groupName}
                </h3>
                  ...
                  {components.map(({ id, label }) => (
                    <li key={id}>
                      <a
                        ...
                        className={`block cursor-pointer w-full text-left px-3 py-1.5 text-sm rounded-md transition-all ${
                          selectedTool === id
      ...
      <div className="flex-1 p-6 min-w-0">{renderSelectedComponent()}</div>
    </div>
  );
}
