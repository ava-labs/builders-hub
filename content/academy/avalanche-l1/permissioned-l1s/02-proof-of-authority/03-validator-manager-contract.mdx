...
The contracts in the [`validator-manager`](https://github.com/ava-labs/icm-services/tree/main/icm-contracts/avalanche/validator-manager) branch define the Validator Manager used to manage Subnet-only Validators. 
