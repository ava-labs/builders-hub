...
edit_url: https://github.com/ava-labs/avalanchego/edit/master/vms/platformvm/docs/mempool_gossiping.md
---
...
In conjunction with the introduction of [Snowman++](https://github.com/ava-labs/avalanchego/blob/master/vms/proposervm), the mempool was opened to the network, allowing the gossiping of local transactions as well as the hosting of remote ones.
