      ...
      <div className="space-y-6">
        ...
        <Steps>
          ...
          <Step>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Start the removal process by selecting the validator to remove and calling the{" "}
              <a
                href="https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L508"
                target="_blank"
              ...
              <Link
                href="/docs/acps/77-reinventing-subnets#l1validatorweightmessage"
                className="text-blue-600 hover:text-blue-800 underline"
              >
          ...
          <Step>
            <h2 className="text-lg font-semibold">
              Sign L1ValidatorWeightMessage & Submit SetL1ValidatorWeightTx P-Chain
            </h2>
            <p className="text-sm text-gray-500 mb-4">
              Sign the{" "}
              <Link
              ...
              and submit the{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#setl1validatorweighttx"
                className="text-blue-600 hover:text-blue-800 underline"
              >
                SetL1ValidatorWeightTx
              </Link>{" "}
              to the P-Chain. This transaction will emit a{" "}
              <Link
          ...
          <Step>
            <h2 className="text-lg font-semibold">
              Sign P-Chain L1ValidatorRegistrationMessage & Submit completeValidatorRemoval on
              Validator Manager contract
            </h2>
            <p className="text-sm text-gray-500 mb-4">
              Complete the validator removal by signing the P-Chain{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#l1validatorregistrationmessage"
                className="text-blue-600 hover:text-blue-800 underline"
              >
              ...
              and calling the{" "}
              <a
                href="https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L573"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-blue-800 underline"
              >
