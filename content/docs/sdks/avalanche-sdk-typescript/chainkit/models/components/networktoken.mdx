---
title: "Network Token"
description: "Chainkit SDK documentation for network token"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/networktoken.md
---
...
```typescript
import { NetworkToken } from "@avalanche-sdk/chainkit/models/components";
