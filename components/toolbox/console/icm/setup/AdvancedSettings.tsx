    ...
    >
      ...
      <div className="p-4 border-t space-y-4 bg-gray-50 dark:bg-gray-900/20">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            <label className="block text-sm font-medium mb-1.5 text-gray-700 dark:text-gray-300">Log Level</label>
            <select
              value={logLevel}
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Controls verbosity of relayer logs</p>
          </div>
          ...
          >
            <Input
              ...
              type="number"
            />
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Port for relayer API endpoints</p>
          </div>
          ...
          >
            ...
            />
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Directory for relayer state storage</p>
          </div>
          ...
          >
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-6">Process historical blocks on restart</p>
          </div>
        </div>
      </div>
    </details>
