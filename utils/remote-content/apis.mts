  ...
  return [
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/admin-api.mdx",
      title: "Admin API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/health-api.mdx",
      title: "Health API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/info-api.mdx",
      title: "Info API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/metrics-api.mdx",
      title: "Metrics API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/index-api.mdx",
      title: "Index API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/p-chain/api.mdx",
      title: "P-Chain API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/x-chain/api.mdx",
      title: "X-Chain API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/c-chain/api.mdx",
      title: "C-Chain API",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/subnet-evm-api.mdx",
    ...
    },
    {
      ...
      outputPath: "content/docs/api-reference/rpc-api/proposervm-api.mdx",
