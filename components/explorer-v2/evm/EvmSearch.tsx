...
export function EvmSearchBox({
  ...
  return (
    ...
    <div ref={wrapRef} className="relative w-full pl-0! pr-0!">
      <div className="flex items-center gap-3 border-b border-zinc-200 py-2.5 transition-colors focus-within:border-zinc-900 dark:border-zinc-800 dark:focus-within:border-zinc-100">
