  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination:
          "/academy/avalanche-fundamentals/04-creating-an-l1/01-creating-an-l1",
        permanent: true,
      },
      // Redirects from old VM paths
      {
        ...
        destination:
          "/docs/avalanche-l1s/evm-configuration/evm-l1-customization#precompiles",
        permanent: true,
      },
      {
        source: "/docs/virtual-machines/default-precompiles/deployerallowlist",
        destination:
          "/docs/avalanche-l1s/evm-configuration/permissions#contract-deployer-allowlist",
        permanent: true,
      },
      {
        source: "/docs/virtual-machines/default-precompiles/txallowlist",
        destination:
          "/docs/avalanche-l1s/evm-configuration/permissions#transaction-allowlist",
        permanent: true,
      },
      {
        source:
          "/docs/virtual-machines/default-precompiles/contractnativeminter",
        destination:
          "/docs/avalanche-l1s/evm-configuration/tokenomics#native-minter",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          "/docs/avalanche-l1s/evm-configuration/transaction-fees#fee-manager",
        permanent: true,
      },
      {
        source: "/docs/virtual-machines/default-precompiles/rewardmanager",
        destination:
          "/docs/avalanche-l1s/evm-configuration/transaction-fees#reward-manager",
        permanent: true,
      },
      {
      ...
      {
        source:
          "/academy/interchain-messaging/10-running-a-relayer/01-running-a-relayer",
        destination:
          "/academy/interchain-messaging/10-running-a-relayer/01-relayer-introduction",
        permanent: true,
      },
      {
        source:
          "/academy/interchain-messaging/10-running-a-relayer/02-control-the-avalanche-cli-relayer",
        destination:
          "/academy/interchain-messaging/10-running-a-relayer/03-configure-and-run-the-relayer",
        permanent: true,
      },
      {
        source:
          "/academy/interchain-messaging/10-running-a-relayer/03-install-relayer",
        destination:
          "/academy/interchain-messaging/10-running-a-relayer/03-configure-and-run-the-relayer",
        permanent: true,
      },
      {
        source:
          "/academy/interchain-messaging/10-running-a-relayer/05-multichain-relayer-config",
        destination:
          "/academy/interchain-messaging/10-running-a-relayer/02-relayer-configuration#multichain-relayer-configuration",
        permanent: true,
      },
      {
        source:
          "/academy/interchain-messaging/10-running-a-relayer/06-analyze-relayer-logs",
        destination:
          "/academy/interchain-messaging/10-running-a-relayer/03-configure-and-run-the-relayer",
        permanent: true,
      },
      {
        source:
          "/academy/interchain-messaging/03-avalanche-starter-kit/03-create-blockchain",
        destination:
          "/academy/interchain-messaging/03-avalanche-starter-kit/04-networks",
        permanent: true,
      },
      {
        source:
          "/academy/interchain-messaging/03-avalanche-starter-kit/06-pause-and-resume",
        destination:
          "/academy/interchain-messaging/03-avalanche-starter-kit/04-networks",
        permanent: true,
      },
      ...
      {
        source:
          "/docs/virtual-machines/evm-customization/generating-your-precompile",
        destination:
          "/docs/virtual-machines/custom-precompiles/create-precompile",
        permanent: true,
      },
      {
        source:
          "/docs/virtual-machines/evm-customization/defining-precompile#event-file",
        destination:
          "/docs/virtual-machines/custom-precompiles/defining-precompile#event-file",
        permanent: true,
      },
      {
        source:
          "/docs/virtual-machines/evm-customization/testing-your-precompile",
        destination:
          "/docs/virtual-machines/custom-precompiles/test-precompile",
        permanent: true,
      },
      {
        source: "/docs/nodes/run-a-node/manually#hardware-and-os-requirements",
        destination:
          "/docs/nodes/system-requirements#hardware-and-operating-systems",
        permanent: true,
      },
      {
        source: "/build/cross-chain/awm/deep-dive",
        destination:
          "/docs/cross-chain/avalanche-warp-messaging/evm-integration#how-does-avalanche-warp-messaging-work",
        permanent: true,
      },
      {
        source:
          "/docs/virtual-machines/custom-precompiles#minting-native-coins",
        destination:
          "/docs/avalanche-l1s/evm-configuration/tokenomics#native-minter",
        permanent: true,
      },
      ...
      {
        source:
          "/docs/virtual-machines/evm-customization/background-requirements",
        destination:
          "/docs/virtual-machines/custom-precompiles/background-requirements",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          "/docs/tooling/create-deploy-avalanche-l1s/deploy-on-fuji-testnet",
        permanent: true,
      },
      {
