---
title: "Get EVM Block Response"
description: "Chainkit SDK documentation for get evm block response"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/getevmblockresponse.md
---
...
```typescript
import { GetEvmBlockResponse } from "@avalanche-sdk/chainkit/models/components";
