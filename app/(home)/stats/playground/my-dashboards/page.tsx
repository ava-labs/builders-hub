    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950 pt-8 relative">
      ...
      >
          ...
          <mask
            ...
            height="861"
          >
            <ellipse cx="468.373" cy="287.536" rx="467.627" ry="430.464" fill="url(#radial-dark-dashboards)" />
          </mask>
          <g mask="url(#mask-dark-dashboards)" className="fill-primary">
