...
L1s **must** upgrade to the latest version of Subnet-EVM to be compatible with the Granite upgrade. [Learn more about upgrading your L1 to Granite](https://build.avax.network/blog/granite-installer#l1ssubnets-nodes).
