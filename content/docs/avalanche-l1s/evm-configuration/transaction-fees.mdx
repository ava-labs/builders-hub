...
```json
{
  "config": {
    "feeManagerConfig": {
      ...
      "initialFeeConfig": {
        "gasLimit": 20000000,
        "targetBlockRate": 2, -- deprecated by the Granite upgrade
        "minBaseFee": 1000000000,
        "targetGas": 100000000, 
        "baseFeeChangeDenominator": 48, 
        "minBlockGasCost": 0, -- deprecated by the Granite upgrade
        "maxBlockGasCost": 10000000, -- deprecated by the Granite upgrade
        "blockGasCostStep": 500000 -- deprecated by the Granite upgrade
      }
    }
  }
}
