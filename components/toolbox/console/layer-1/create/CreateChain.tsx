...
import {
  ChainConfigStep,
  generateRandomChainName,
} from "@/components/toolbox/components/genesis/ChainConfigStep";
...
function CreateChain({ onSuccess, embedded = false }: CreateChainProps) {
  ...
  const canProceedToStep4 =
    canProceedToStep3 && !!genesisData && genesisData !== "" && !genesisData.startsWith("Error:");
  ...
  return (
    <div className="space-y-6">
      <Steps>
        ...
        <Step>
          <SubnetStep subnetId={subnetId} onSubnetIdChange={setSubnetID} />
        </Step>
