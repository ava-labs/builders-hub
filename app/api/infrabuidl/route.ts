...
export async function POST(request: Request) {
  try {
    if (!HUBSPOT_API_KEY || !HUBSPOT_PORTAL_ID || !HUBSPOT_INFRABUIDL_FORM_GUID) {
      console.error(
        "Missing environment variables: HUBSPOT_API_KEY, HUBSPOT_PORTAL_ID, or HUBSPOT_INFRABUIDL_FORM_GUID"
      );
    ...
    processedFormData["2-44649732/applicant_job_role_other"] =
      formData.applicant_job_role_other || "N/A";
    processedFormData["2-44649732/avalanche_l1_project_benefited_1"] =
      formData.avalanche_l1_project_benefited_1 || "N/A";
    processedFormData["2-44649732/previous_avalanche_project_info"] =
      formData.previous_avalanche_project_info || "N/A";
    processedFormData["2-44649732/direct_competitor_1_website"] =
      formData.direct_competitor_1_website || "N/A";
    ...
    processedFormData["2-44649732/avalanche_l1_project_benefited_1_website"] =
      formData.avalanche_l1_project_benefited_1_website || "N/A";
    ...
    processedFormData["2-44649732/requested_funding_range"] =
      formData.requested_funding_range_milestone || "N/A";

    // Handle new funding amount fields
    processedFormData["2-44649732/previous_funding_amount_codebase"] =
      formData.funding_amount_codebase || "0";
    processedFormData["2-44649732/previous_funding_amount_infrabuidl"] =
      formData.funding_amount_infrabuidl || "0";
    processedFormData["2-44649732/previous_funding_amount_infrabuidl_ai"] =
      formData.funding_amount_infrabuidl_ai || "0";
    processedFormData["2-44649732/retro9000_previous_funding_amount"] =
      formData.funding_amount_retro9000 || "0";
    processedFormData["2-44649732/previous_funding_amount_blizzard"] =
      formData.funding_amount_blizzard || "0";
    processedFormData["2-44649732/previous_funding_amount_ava_labs"] =
      formData.funding_amount_ava_labs || "0";
    processedFormData["2-44649732/previous_funding_amount_entity_other"] =
      formData.funding_amount_other_avalanche || "0";

    // Handle previous funding non-avalanche fields
    const previousFunding = Array.isArray(formData.previous_funding)
      ? formData.previous_funding
      : [formData.previous_funding];
    processedFormData["2-44649732/previous_funding_non_avalanche_grant"] = previousFunding.includes(
      "Grant"
    )
      ? "Yes"
      : "No";
    processedFormData["2-44649732/previous_funding_non_avalanche___angel_investment"] =
      previousFunding.includes("Angel Investment") ? "Yes" : "No";
    processedFormData["2-44649732/previous_funding_non_avalanche___pre_seed"] =
      previousFunding.includes("Pre-Seed") ? "Yes" : "No";
    processedFormData["2-44649732/previous_funding_non_avalanche___seed"] =
      previousFunding.includes("Seed") ? "Yes" : "No";
    processedFormData["2-44649732/previous_funding_non_avalanche___series_a"] =
      previousFunding.includes("Series A") ? "Yes" : "No";

    // Handle similar project fields
    processedFormData["2-44649732/similar_project_name_1"] =
      formData.similar_project_name_1 || "N/A";
    processedFormData["2-44649732/similar_project_website_1"] =
      formData.similar_project_website_1 || "N/A";
