...
export function LinkedInIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      <path d="M20.45 20.45h-3.55v-5.57c0-1.33-.02-3.04-1.85-3.04-1.85 0-2.13 1.45-2.13 2.94v5.67H9.36V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43A2.06 2.06 0 113.28 5.36a2.06 2.06 0 012.06 2.07zM7.12 20.45H3.56V9h3.56v11.45zM22.22 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.45c.98 0 1.78-.77 1.78-1.72V1.72C24 .77 23.2 0 22.22 0z" />
    </svg>
  );
}
...
export function WebsiteIcon({ size = 14, className }: IconProps) {
  return (
...
export function GraduationIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
...
export function BlockIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <path d="M21 8.5L12 13 3 8.5M21 8.5l-9-5-9 5M21 8.5v7L12 21l-9-5V8.5M12 13v8" />
    </svg>
  );
}
...
export function GiftIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <path d="M12 5.5V8M12 5.5C12 4.12 13.12 3 14.5 3S17 4.12 17 5.5 15.88 8 14.5 8M12 5.5C12 4.12 10.88 3 9.5 3S7 4.12 7 5.5 8.12 8 9.5 8M12 8h2.5M12 8H9.5M12 8v6M14.5 8H17.8c1.12 0 1.68 0 2.11.22.37.19.68.5.87.87.22.43.22.99.22 2.11V14M9.5 8H6.2c-1.12 0-1.68 0-2.11.22-.37.19-.68.5-.87.87C3 9.52 3 10.08 3 11.2V14M3 14v2.8c0 1.12 0 1.68.22 2.11.19.37.5.68.87.87.43.22.99.22 2.11.22H12M3 14h9m0 0v6m0-6h9m-9 6h5.8c1.12 0 1.68 0 2.11-.22.37-.19.68-.5.87-.87.22-.43.22-.99.22-2.11V14" />
    </svg>
  );
}
...
export function PuzzleIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <path d="M20 7h-2.15c-.5 0-.85-.5-.85-1a3 3 0 10-6 0c0 .5-.35 1-.85 1H8a1 1 0 00-1 1v2.15c0 .5-.5.85-1 .85a3 3 0 100 6c.5 0 1 .35 1 .85V20a1 1 0 001 1h12a1 1 0 001-1v-2.15c0-.5-.5-.85-1-.85a3 3 0 110-6c.5 0 1-.35 1-.85V8a1 1 0 00-1-1z" />
    </svg>
  );
}
...
export function LinkIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <path d="M9.17 14.83l5.66-5.66M7.05 11.29L5.64 12.7c-1.56 1.57-1.56 4.1 0 5.66 1.56 1.57 4.1 1.56 5.66 0l1.41-1.41M11.29 7.05L12.71 5.64c1.56-1.57 4.09-1.57 5.65 0 1.57 1.56 1.57 4.1 0 5.66l-1.42 1.41" />
    </svg>
  );
}
