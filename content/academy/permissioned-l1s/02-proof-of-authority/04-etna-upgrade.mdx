...
This progression from ACP-77 (protocol capability) to ACP-99 (standardized implementation) mirrors successful patterns in blockchain development, like how Ethereum's protocol upgrades are followed by standardized contracts (ERC-20, ERC-721, etc.).