...
- **API-First Design**: APIs for integrating into any platform.
...
Rain supports diverse payment use cases:
...
Rain's non-custodial card capability:
...
This is particularly useful for Web3-native applications where user custody matters.

## Visa Principal Membership

Rain's Visa principal membership provides these advantages:
...
Rain maintains compliance infrastructure including:
...
**Developer APIs**: Developer-friendly integration with documentation.

**Revenue Sharing**: Earn interchange revenue from card transactions.

## Technology Infrastructure

Rain's technology stack includes:
