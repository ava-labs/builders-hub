  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <Link href="/console/permissioned-l1s/add-validator?flow=manage-validators" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            <div className="flex items-start justify-between mb-4">
              <div className="p-2 rounded-lg bg-muted">
        ...
        {/* Token Transfer */}
        <Link href="/console/ictt/deploy-native-home" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            <div className="flex items-start justify-between mb-4">
              <div className="p-2 rounded-lg bg-muted">
