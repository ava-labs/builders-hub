...
**Option 1 (Recommended):** Create a [Builder Hub account](https://hub.avax.network) and connect your wallet to receive testnet AVAX automatically.
...
- **Recommended:** Create a [Builder Hub account](https://hub.avax.network) and connect your wallet to receive testnet AVAX automatically
