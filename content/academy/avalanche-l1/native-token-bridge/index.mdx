...
description: Learn about bridging native tokens to another L1s with Avalanche Interchain Token Transfer.
updated: 2024-05-31
authors: [ashucoder9]
icon: Smile
---

In this course, you will learn how to bridge native tokens across multiple Avalanche blockchains with Avalanche Interchain Token Transfer (ICTT).
