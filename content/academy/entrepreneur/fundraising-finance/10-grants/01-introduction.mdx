...
<YouTube id="UtT33I_HvLU" params="start=0&rel=0&modestbranding=1" />
...
<YouTube id="l1aRqsyj_J0" params="start=0&rel=0&modestbranding=1" />
...
- **Codebase** *(no longer active)*: Was an accelerator with mentorship, focused on moving from MVP to product

The [grant programs](https://build.avax.network/grants) are designed to fill specific ecosystem gaps, operate on a milestone-based structure, and remain open year-round for applications.
