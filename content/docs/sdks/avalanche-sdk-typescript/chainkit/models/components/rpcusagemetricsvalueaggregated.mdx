---
title: "RPC Usage Metrics Value Aggregated"
description: "Chainkit SDK documentation for rpc usage metrics value aggregated"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/rpcusagemetricsvalueaggregated.md
---
...
| `groupedBy`                                                                                                              | [components.RpcUsageMetricsValueAggregatedGroupedBy](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/rpcusagemetricsvalueaggregatedgroupedby.md) | :heavy_check_mark:                                                                                                       | Column name used for data aggregation                                                                                    |
