    ...
    <div className="space-y-4">
      <div>
        ...
        <Note variant="warning" className="mt-2">
          <span className="font-semibold">Important:</span> The Relayer EVM Address above uses a
          temporary private key generated in your browser. Feel free to replace it with another
          private key in the relayer config file (field <code>account-private-key</code> of all
          destination blockchains). This generated key is stored only in session storage and will be{" "}
          <span className="font-semibold">lost when you close this browser tab</span>. Ensure you
          fund this address sufficiently.
        </Note>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400">
          Ensure the relayer address maintains a positive balance on all selected chains to cover
          transaction fees.
        </div>
