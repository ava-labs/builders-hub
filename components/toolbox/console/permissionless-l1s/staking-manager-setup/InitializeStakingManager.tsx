...
function InitializeStakingManagerInner({ onSuccess }: BaseConsoleToolProps) {
  ...
  const { validatorManagerAddress, error: validatorManagerError } = useValidatorManagerDetails({
    subnetId: subnetSelection.subnetId,
  });
          ...
          <Steps>
            ...
            <Step>
              <div onFocus={() => setActiveStep(2)}>
                ...
                <p className="text-sm text-gray-500 mb-4">Set the reward calculator contract address.</p>
                  ...
                  <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-md mb-4">
                    ...
                    {blockchainId && (
                      <p className="text-sm mt-1">
                        <strong>Blockchain ID:</strong> <code className="text-xs">{blockchainId.slice(0, 12)}...</code>
                      </p>
                    )}
                  </div>
                )}
