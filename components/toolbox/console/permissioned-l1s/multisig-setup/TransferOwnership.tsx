...
const metadata: ConsoleToolMetadata = {
  ...
  description:
    "Transfer the ownership of the Validator Manager to a new address (EOA, StakingManager, or PoAManager)",
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        {showOwnershipError && (
          <Alert variant="error">
            You are not the owner of this Validator Manager. Only the current owner can transfer
            ownership.
          </Alert>
        )}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-700 dark:text-amber-300 mb-2">
                  The new owner address is a contract. Please ensure this contract is either a{" "}
                  <strong>PoAManager</strong> or <strong>StakingManager</strong> that follows the
                  ACP-99 standard.
                </p>
