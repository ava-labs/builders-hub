...
All configuration options and their default values are described [here](/docs/primary-network/configure/configs-flags).
...
[here](/docs/primary-network/chain-configs/c-chain).
...
for C-Chain API [here](/docs/apis/c-chain/api).
...
- The detailed dynamic gas fee can be found [here](/docs/dapps/advanced-tutorials/dynamic-gas-fees).
