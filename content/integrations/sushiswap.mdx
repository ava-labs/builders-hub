...
SushiSwap is a decentralized exchange (DEX) operating across multiple chains, including Avalanche's C-Chain. It supports token swapping, yield farming, and liquidity provision. Built on the AMM model, SushiSwap maintains deep liquidity across various trading pairs.
...
For guides and technical documentation, visit the [Sushi Documentation](https://docs.sushi.com/).
