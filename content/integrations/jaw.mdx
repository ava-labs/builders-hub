...
available: ["C-Chain"]
description: "Smart account infrastructure with passkey authentication, gasless transactions, and programmable permissions for Avalanche applications."
logo: /images/jaw.png
developer: JAW
...
Add a paymaster to your config to sponsor gas fees so users never need to hold AVAX. JAW requires an ERC-7677 compatible paymaster using EntryPoint v0.8.
