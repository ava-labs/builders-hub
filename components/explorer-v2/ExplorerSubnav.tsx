...
function ChainSwitcher({
  ...
  return (
    <div ref={rootRef} className="relative flex shrink-0 items-stretch">
      ...
      {open && (
        // z-50 within the subnav's stacking context: clears page content
        // and the stats pages' sticky section bar (z-30)
...
export function ExplorerSubnav({
  ...
  return (
    ...
    // content never peeks past its edges; z-[35] keeps it (and the chain
    // switcher's dropdown) above the stats pages' sticky bars (z-30) while
    // staying under the global navbar (z-40), whose hover mega-menu sheet
    // lives inside the navbar's stacking context and must cover this rail.
    <div
      className={cn(
