...
export function NavbarDropdown() {
    ...
    },
    {
      ...
      items: [
        { text: "Hackathons", href: "/hackathons" },
        {
          ...
          href: "https://lu.ma/calendar/cal-Igl2DB6quhzn7Z4",
          external: true,
        },
        {
  ...
  return (
    <div className="relative" data-navbar-dropdown ref={dropdownRef}>
      ...
      >
        <ChevronDown
          className={`size-5.5 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
      ...
      {isOpen && (
        <>
          {/* Dropdown menu */}
          <div className="absolute right-0 top-full mt-2 w-[90vw] max-w-md bg-background border border-border rounded-lg shadow-lg z-[100] max-h-[70vh] overflow-y-auto">
