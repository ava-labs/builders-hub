...
Mt Pelerin is a Swiss-regulated fintech company that provides a crypto-fiat gateway for buying, selling, swapping, and managing cryptocurrencies. Based in Switzerland, it supports 163 countries. Their flagship product, Bridge Wallet, is a mobile app for investing in and managing crypto assets with full self-custody.

Mt Pelerin supports Avalanche along with major cryptocurrencies and stablecoins, providing on-ramp, off-ramp, and swap functionality. It offers both consumer-facing solutions and developer APIs for integrating crypto services into applications.
...
- **Cross-Chain Bridge**: Move assets between different blockchain networks.
- **Bridge Wallet App**: Mobile app for managing crypto investments with full self-custody.
...
Mt Pelerin's Bridge Wallet is a mobile application that provides:
