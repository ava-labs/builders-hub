...
Thirdweb's x402 facilitator is a service that handles verifying and submitting x402 payments on Avalanche's C-Chain. It uses your own server wallet and EIP-7702 to submit transactions gaslessly, making it easy to integrate payment-gated APIs and AI services.
...
- **Gasless Transactions**: Uses EIP-7702 for user-friendly payment experience
