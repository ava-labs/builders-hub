...
<span style={{ fontWeight: 'bold' }}>"I would take ten of those actively promoting community members, over a thousand spectators in your community."</span> - Ben Wellington, former Head of Community at Ava Labs
</div>
</Callout>

<YouTube id="7Y9FQ8c9UIA" params="start=0&rel=0&modestbranding=1" />

<p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.95rem', color: '#666' }}>
  Learn from Ben Wellington, former Head of Community at Ava Labs
</p>