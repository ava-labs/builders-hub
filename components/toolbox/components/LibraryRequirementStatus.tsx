    ...
    return (
      <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-md">
        <p className="text-sm text-red-800 dark:text-red-200">
          <strong>Required:</strong> {libraryName} library must be deployed first. Please go to the{' '}
          <strong>Validator Manager Setup</strong> section and deploy the {libraryName} library.
        </p>
      </div>
    );
  }
