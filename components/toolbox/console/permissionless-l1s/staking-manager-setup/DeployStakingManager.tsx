  ...
  return (
    <div className="space-y-4">
      <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
        <h3 className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-3">Select Token Type</h3>
        <div className="flex gap-3">
          ...
          >
            <div className="text-left">
              ...
              <div className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">Use the L1's native token for staking</div>
            </div>
          </button>
          <button
          ...
          >
            <div className="text-left">
              ...
              <div className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">Use a custom ERC20 token for staking</div>
            </div>
          </button>
        </div>
      </div>
      ...
      >
        {!validatorMessagesLibAddress ? 'Deploy ValidatorMessages Library First' : `Deploy ${contractName}`}
      </Button>

      <p>
        Deployment Status: <code>{contractAddress || 'Not deployed'}</code>
      </p>

      {contractAddress && <Success label={`${contractName} Address`} value={contractAddress} />}
    </div>
  );
}
