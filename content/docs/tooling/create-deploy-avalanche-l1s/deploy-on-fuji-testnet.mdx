...
- **Recommended:** Create a [Builder Hub account](https://hub.avax.network) and connect your wallet to receive testnet tokens automatically
...
1. A newly created key has no funds on it. You have several options to fund it:
   - **Recommended:** Create a [Builder Hub account](https://hub.avax.network) and connect your wallet to receive testnet tokens automatically on C-Chain and P-Chain
