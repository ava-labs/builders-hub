...
export function formatTokenValue(
  ...
  const { maxDecimals = 6, minDecimals = 2, showZero = true, trimTrailingZeros = true } = options;
 ...
 */
function formatWithCommas(value: number, maxDecimals: number, trimTrailingZeros: boolean): string {
