...
C-Chain exposes the [same API](/docs/apis/c-chain/api) as
...
[here](/docs/primary-network/configure/configs-flags). But unless you have
...
C-Chain [here](/docs/primary-network/chain-configs/c-chain) as well
...
Default config values for the C-Chain can be seen [here](/docs/primary-network/chain-configs/c-chain).
