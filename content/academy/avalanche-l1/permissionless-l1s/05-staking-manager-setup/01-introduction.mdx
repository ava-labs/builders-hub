...
Check out the complete diagram and code implementation on [github](https://github.com/ava-labs/icm-services/tree/main/icm-contracts/avalanche/validator-manager).
