...
export default function SubmitStep3() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-xl font-semibold text-foreground">3) Visual Identity & Media</h2>
          ...
          render={({ field }) => (
            <FormItem className="space-y-2">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 ">
                Showcase your project in action with a short demo video. Ensure the link is
                accessible and not set to private. <br />
                Video requirements: <br />
                - Minimum resolution: 720p <br />
                - Ensure audio is clear, no background music <br />- Platforms supported: YouTube,
                Vimeo, Google Drive (public link)
              </p>
              <FormMessage />
            </FormItem>
          )}
