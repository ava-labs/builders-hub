...
This method is deprecated. After the Helicon upgrade, the public API endpoints do not serve it. Use [`avax.getAtomicTx`](#avaxgetatomictx) instead. When the transaction is accepted, `avax.getAtomicTx` returns `blockHeight`.
</Callout>
