            ...
            <Board>
              ...
              {b.transactions.map((t) => (
                <Link
                  key={t.hash}
                  href={`${base}/tx/${t.hash}`}
                  className="grid grid-cols-2 gap-x-4 gap-y-1 px-5 py-3 transition-colors hover:bg-zinc-50 md:grid-cols-[1.6fr_1.4fr_0.9fr_5rem] md:items-center md:px-6 dark:hover:bg-zinc-900"
                >
