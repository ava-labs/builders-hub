...
- **Rewards**: Validators are eligible to receive rewards for their efforts in securing the network. To receive rewards, a validator must be online and responsive for more than 90% of their validation period (80% for validations that started before the [Helicon](/docs/primary-network/helicon-upgrade) upgrade).
