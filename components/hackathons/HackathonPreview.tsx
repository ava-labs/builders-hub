      ...
      <div className="grid grid-cols-1 lg:grid-cols-4">
        ...
        <div className="bg-zinc-700 dark:bg-zinc-800 p-6 shadow-md flex flex-col items-start justify-center">
          ...
          <p className="text-sm text-zinc-50">
            Your project must include a GitHub repo, slides for your pitch, and any additional
            content.
          </p>
        </div>
        ...
        <div className="bg-zinc-200 dark:bg-zinc-900 p-6 shadow-md flex flex-col items-start justify-center">
          ...
          <p className="text-sm">
            Projects will be judged on value proposition, technical complexity and usage of
        ...
        <div className="bg-zinc-700 dark:bg-zinc-800 p-6 shadow-md flex flex-col items-start justify-center lg:rounded-tr-md rounded-bl-md lg:rounded-bl-none rounded-br-md">
          ...
          <p className="text-sm text-zinc-50">
            ...
            your GitHub repo, presentation slides along with any other file that support your
            submission.
          </p>
        </div>
      </div>
  ...
  const transformedHackathon = {
    ...
    content: {
      ...
      partners: (hackathonData.content?.partners || []).map((partner: any) =>
        typeof partner === "string" ? { name: partner, about: "", links: [] } : partner
      ),
      ...
      submission_deadline: hackathonData.content?.submission_deadline
        ? new Date(hackathonData.content.submission_deadline)
        : new Date(),
      registration_deadline: hackathonData.content?.registration_deadline
        ? new Date(hackathonData.content.registration_deadline)
        : new Date(),
      address: "",
      become_sponsor_link: "",
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button className="bg-red-500 hover:bg-red-600 text-white">Join now</Button>
              </div>
            </div>
            ...
            <div className="flex flex-col mt-2">
              <div className="sm:px-8 pt-6">
                ...
                <div className="py-8 sm:p-8 flex flex-col gap-20">
                  ...
                  {transformedHackathon.content.tracks &&
                    transformedHackathon.content.tracks.length > 0 && (
                      <Tracks hackathon={transformedHackathon} />
                    )}
                  <Resources hackathon={transformedHackathon} />
                  {transformedHackathon.content.schedule &&
                    transformedHackathon.content.schedule.length > 0 && (
                      <Schedule hackathon={transformedHackathon} />
                    )}
                  <SubmissionPreview hackathon={transformedHackathon} />
                  {transformedHackathon.content.speakers &&
                    transformedHackathon.content.speakers.length > 0 && (
