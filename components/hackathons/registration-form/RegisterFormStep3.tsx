    ...
    <>
      ...
      <div className="mb-6">
        ...
        <p className="text-zinc-400">
          Review and agree to the terms to complete your registration. For information about our
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-start space-x-3 space-y-0">
              ...
              <div className="space-y-1 leading-none">
                <FormLabel>
                  I have read and agree to the Event Participation{" "}
                  <a
                ...
                <FormMessage className="text-zinc-400">
                  You must agree to participate in any Builder Hub events. Event Terms and
                  Conditions.
                </FormMessage>
              </div>
            </FormItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                ...
                <div className="space-y-1 leading-none">
                  <FormLabel>
                    I agree not to bring any of the following prohibited items. *
                  </FormLabel>
                  <FormMessage className="text-zinc-400">
