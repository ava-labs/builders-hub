...
import { useMarkSubmissionAsPaidMutation } from "@/services/ambassador-dao/requests/sponsor";
...
export const MarkSubmissionAsPaidModal = ({
  isOpen,
  onClose,
  submissionId,
  opportunityId,
  ...
  const { mutateAsync: markSubmissionAsPaid, isPending } =
    useMarkSubmissionAsPaidMutation(submissionId, opportunityId);
