      ...
      <AlertDialog open={isOpen} onOpenChange={handleClose}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You have reached the maximum number of API keys allowed. Please delete an existing key before creating a
              new one.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
        ...
        <div className="space-y-4 py-4">
          <div>
            ...
            <input
              ...
              disabled={isCreating}
            />
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{alias.length}/64 characters</p>
          </div>
        </div>
