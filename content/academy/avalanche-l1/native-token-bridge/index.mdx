...
<Callout>
Since Interchain Token Transfer relies on Interchain Messaging (ICM), if you choose to do this on your own L1 - you must run your own relayer to enable cross-chain communication. Follow the [Running a Relayer](/academy/avalanche-l1/interchain-messaging/09-running-a-relayer/01-relayer-introduction) course to set up your relayer.
</Callout>
