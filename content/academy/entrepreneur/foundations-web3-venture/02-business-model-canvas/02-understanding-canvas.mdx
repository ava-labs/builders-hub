...
<YouTube id="0IFf_MU1vyE" params="start=0&rel=0&modestbranding=1" /> 
...
<YouTube id="72gPKv0n1lg" params="start=0&rel=0&modestbranding=1" /> 
...
<span style={{ fontWeight: 'bold' }}>"'If you build it they will come is not a strategy.' That is a maxim that I would argue does not hold real weight."</span> - [Michael Martin](https://www.linkedin.com/in/michaeltmartin/), Former Codebase Lead at Ava Labs
</div>
</Callout>
...
<YouTube id="2pya2sOvtmc" params="start=0&rel=0&modestbranding=1" /> 
