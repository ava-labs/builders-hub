...
export default function AllowList({ addresses, onUpdateAllowlist, precompileAction }: AllowlistProps) {
  const isAddressInvalid = useCallback(
    (address: string, _: Role, currentId?: string, currentAddresses = addresses): string | undefined => {
