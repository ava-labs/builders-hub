...
[`platform.getValidatorFeeState`](https://build.avax.network/docs/apis/p-chain/api#platformgetvalidatorfeestate).

An L1 validator's available remaining balance can be retrieved using the P-Chain API endpoint
[`platform.getL1Validator`](https://build.avax.network/docs/apis/p-chain/api#platformgetl1validator).
...
[`platform.getValidatorFeeConfig`](https://build.avax.network/docs/apis/p-chain/api#platformgetvalidatorfeeconfig).
...
endpoint [`platform.getValidatorFeeConfig`](https://build.avax.network/docs/apis/p-chain/api#platformgetvalidatorfeeconfig).
