    ...
    return (
        ...
        >
            <Steps>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                >
                                    ...
                                    <div className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Port 9651 (P2P)</div>
                                </button>
                                <button
                                    type="button"
                                ...
                                >
                                    ...
                                    <div className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Port 9650 (HTTP)</div>
                                </button>
                                <button
                                    type="button"
                                ...
                                >
                                    ...
                                    <div className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">Ports 9650 + 9651</div>
                                </button>
                            </div>
                            {nodeType === "validator-rpc" && (
                ...
                <Step>
                    <h3 className="text-sm font-semibold mb-3">Select L1</h3>
                    <p className="text-sm text-muted-foreground mb-4">
                ...
                {subnetId && blockchainInfo && (
                    <>
                        <Step>
                            <h3 className="text-sm font-semibold mb-3">Create Configuration File</h3>
                            <p className="text-sm text-muted-foreground mb-4">
                        ...
                        <Step>
                            <h3 className="text-sm font-semibold mb-3">Run Docker Command</h3>
                            <p className="text-sm text-muted-foreground mb-4">
