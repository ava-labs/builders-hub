---
title: Avalanche-CLI Overview (Deprecated)
description: Build, deploy, and manage Avalanche L1s with the Avalanche-CLI (deprecated)
---

> **Deprecated:** Avalanche-CLI is no longer actively maintained. For P-Chain operations (staking, transfers, subnets, L1 validators), use [Platform CLI](/docs/tooling/platform-cli) instead.
