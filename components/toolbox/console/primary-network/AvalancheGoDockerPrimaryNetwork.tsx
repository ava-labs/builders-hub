...
import {
  generateChainConfig,
  generateConfigFileCommand,
} from "@/components/toolbox/console/layer-1/node-config";
    ...
    >
      <Steps>
        <Step>
          ...
          <p>
            Set up a linux server with any cloud provider, like AWS, GCP, Azure, or Digital Ocean.
            Requirements scale with stake weight:
          </p>
          <ul className="list-disc pl-5 mt-2 mb-4">
            <li>
              <strong>Low stake:</strong> 4 cores, 16GB RAM, 1TB NVMe SSD
            </li>
            <li>
              <strong>High stake:</strong> 8+ cores, 32GB RAM, 2TB NVMe SSD
            </li>
          </ul>
          <p className="text-sm text-amber-600 dark:text-amber-400 mb-4">
            <strong>Important:</strong> Use local NVMe storage, not cloud block storage (EBS,
            Persistent Disk). See{" "}
            <Link href="/docs/nodes/system-requirements" className="underline hover:no-underline">
              system requirements
            </Link>{" "}
            for details.
          </p>
          <p>
            If you do not have access to a server, you can also run a node for educational purposes
            locally. Simply select the &quot;Public RPC Node&quot; option in the next step.
          </p>
        </Step>
        ...
        <Step>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div
                onMouseEnter={() => setHighlightPath("logLevel")}
              ...
              {nodeType === "validator" && (
                ...
                >
                  ...
                  />
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    The minimum delay between blocks (in milliseconds). Maximum: 2000ms. Default:
                    1200ms.
                  </p>
                </div>
              )}
              ...
              <div
                onMouseEnter={() => setHighlightPath("pruning")}
                onMouseLeave={clearHighlight}
                role="group"
              >
              ...
              {nodeType === "public-rpc" && (
                <div
                  onMouseEnter={() => setHighlightPath("ethApis")}
                  onMouseLeave={clearHighlight}
                  role="group"
                >
                  <label className="flex items-center space-x-2">
                  ...
                  <div className="space-y-4 mt-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div
                          onMouseEnter={() => setHighlightPath("trieCleanCache")}
                          onMouseLeave={clearHighlight}
                        >
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("trieDirtyCache")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                            Trie Dirty Cache (MB)
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("snapshotCache")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                            Snapshot Cache (MB)
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("acceptedCacheSize")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                    ...
                    <div className="border-t pt-3">
                      ...
                      <div className="space-y-3">
                        <div
                          onMouseEnter={() => setHighlightPath("commitInterval")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("rpcGasCap")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                            RPC Gas Cap
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("rpcTxFeeCap")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                            RPC Tx Fee Cap (AVAX)
                    ...
                    <div className="border-t pt-3">
                      ...
                      <div className="space-y-3">
                        <div
                          onMouseEnter={() => setHighlightPath("batchRequestLimit")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                            Batch Request Limit
                    ...
                    <div className="border-t pt-3">
                      ...
                      <div className="space-y-3">
                        <div
                          onMouseEnter={() => setHighlightPath("transactionHistory")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("skipTxIndexing")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="flex items-center space-x-2">
                            <input
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("stateSyncEnabled")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="flex items-center space-x-2">
                            <input
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("preimagesEnabled")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="flex items-center space-x-2">
                            <input
                        ...
                        <div
                          onMouseEnter={() => setHighlightPath("localTxsEnabled")}
                          onMouseLeave={clearHighlight}
                        >
                          <label className="flex items-center space-x-2">
                            <input
        ...
        <Step>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            ...
            <code className="px-1 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs">
              ~/.avalanchego/configs/chains/{C_CHAIN_ID}/config.json
            </code>
          </p>
        ...
        <Step>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            The container will read the config from{" "}
            <code className="px-1 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs">
              ~/.avalanchego/configs/chains/{C_CHAIN_ID}/config.json
            </code>{" "}
          ...
          <Accordions type="single" className="mt-4">
            <Accordion title="Running Multiple Nodes on the same machine">
              ...
              <p className="mt-1 text-sm">
                Example for second node: Use ports 9652/9653, container name &quot;avago2&quot;, and
                data directory &quot;~/.avalanchego2&quot;
              </p>
            </Accordion>
        ...
        {nodeType === "validator" && (
          <Step>
            ...
            <p>
              Your node will now bootstrap and sync the Primary Network (P-Chain, X-Chain, and
              C-Chain). This process can take <strong>several hours to days</strong> depending on
              your hardware and network connection.
            </p>
            ...
            <Accordions type="single" className="mt-8">
              <Accordion title="Understanding the Logs">
                ...
                <ul className="list-disc pl-5 mt-1">
                  <li>
                    <strong>P-Chain (Platform Chain):</strong> Handles platform operations and
                    staking
                    <DynamicCodeBlock
                      lang="bash"
        ...
        {nodeIsReady && nodeType === "validator" && (
          <Step>
            ...
            <p>
              Your AvalancheGo Primary Network node is now fully bootstrapped and ready to be used
              as a validator node.
            </p>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                    Your node has successfully synced with the Primary Network and is ready to be
                    added as a validator.
                  </p>
                </div>
              </div>
            </div>
