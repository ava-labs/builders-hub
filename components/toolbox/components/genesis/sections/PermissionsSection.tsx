...
export const PermissionsSection = ({
  ...
  return (
    <SectionWrapper
      title="Permissions"
      description={
        compact ? "" : "Optional permissioning for transaction submitters and contract deployers."
      }
      ...
      <div className="space-y-6">
        ...
        <AllowlistPrecompileConfigurator
          ...
          description={
            compact
              ? ""
              : "Restrict which addresses can deploy smart contracts. Configure Admin, Manager, and Enabled roles with different permission levels."
          }
        ...
        <AllowlistPrecompileConfigurator
          ...
          description={
            compact
              ? ""
              : "Control which addresses can submit transactions. Assign Admin, Manager, and Enabled roles with varying permissions."
          }
