        ...
        <Steps>
          <Step>
            ...
            <p className="text-sm text-gray-500">
              This will deploy the <code>ValidatorMessages</code> contract to the EVM network{" "}
              <code>{viemChain?.id}</code>. <code>ValidatorMessages</code> is a library required by
              the <code>ValidatorManager</code> family of contracts.
            </p>
            <p className="text-sm text-gray-500">
              Library source:{" "}
              <a href={VALIDATOR_MESSAGES_SOURCE_URL} target="_blank" rel="noreferrer">
            ...
            <p>
              Deployment Status: <code>{validatorMessagesLibAddress || "Not deployed"}</code>
            </p>
          </Step>
          ...
          <Step>
            ...
            <p className="text-sm text-gray-500">
              This will deploy the <code>ValidatorManager</code> contract to the EVM network{" "}
              <code>{viemChain?.id}</code>. It is the interface for managing the validators for it's
              L1. The contract emits the ICM messages to change the L1s validator set on the
              P-Chain.
            </p>
            <p className="text-sm text-gray-500">
              Contract source:{" "}
              <a href={VALIDATOR_MANAGER_SOURCE_URL} target="_blank" rel="noreferrer">
            ...
            <p>
              Deployment Status: <code>{validatorManagerAddress || "Not deployed"}</code>
            </p>
          </Step>
        </Steps>
      </div>
