...
If you are interested in the entire implementation, check it out [here](https://github.com/ava-labs/icm-services/blob/main/icm-contracts/avalanche/teleporter/registry/TeleporterRegistry.sol).
