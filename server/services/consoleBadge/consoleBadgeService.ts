...
const CONSOLE_BADGES: ConsoleBadgeDefinition[] = [
  // Bronze
  {
    ...
    imagePath: '/badges/console/first_blood.png',
  ...
  },
  {
    ...
    imagePath: '/badges/console/recruit.png',
    triggeredBy: ['console_log'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/funded.png',
  ...
  },
  {
    ...
    imagePath: '/badges/console/oops.png',
    triggeredBy: ['console_log'],
  ...
  // Silver
  {
    ...
    imagePath: '/badges/console/serial_deployer.png',
    triggeredBy: ['console_log'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/rascal.png',
    triggeredBy: ['faucet_claim'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/contract_factory.png',
    triggeredBy: ['console_log'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/node_runner.png',
  ...
  },
  {
    ...
    imagePath: '/badges/console/validator_wrangler.png',
    triggeredBy: ['console_log'],
  ...
  // Gold
  {
    ...
    imagePath: '/badges/console/chain_lord.png',
    triggeredBy: ['console_log'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/whale.png',
    triggeredBy: ['faucet_claim'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/full_stack.png',
  ...
  // Platinum
  {
    ...
    imagePath: '/badges/console/nuke.png',
    triggeredBy: ['console_log'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/speed_demon.png',
    triggeredBy: ['console_log'],
  ...
  },
  {
    ...
    imagePath: '/badges/console/night_owl.png',
    triggeredBy: ['console_log'],
