...
// /api/avax-dat-etf route overlays AVAX One holdings and VAVX AUM/holdings on
// top of these baseline values; static fields (description, highlights, links)
// stay as-is.
...
export const ETFS: EtfEntry[] = [
  {
    ...
    exchange: "NASDAQ",
    aum: 3_130_000,
    avaxHoldings: 343_000,
    sponsorFee: 0,
    sponsorFeeAfterWaiver: 0.2,
    stakingPct: 0,
    stakingMax: 0,
    status: "Live",
    description:
      "First U.S.-listed AVAX spot ETF. Launched January 2026. Sponsor fee waived through Feb 28, 2026.",
    highlights: [
      "First U.S. spot AVAX ETF",
      "Sponsor fee waived through Feb 28, 2026 (then 0.20%)",
      "Staking enabled",
      "Listed on NASDAQ",
    ],
    color: "#E84142",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Up to 85% of AVAX may be staked",
      "Sponsor fee: 0.50%",
...
export const ETF_HISTORY: HistoryPoint[] = [
  ...
  { date: "May 2026", avax: 4_842_233, label: "Current combined ETF holdings" },
];
