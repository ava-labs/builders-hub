...
describe("L1 Conversion Tests", () => {
  it("should correctly marshal subnet to L1 conversion data", () => {
    ...
    expect(bufferToHex(conversionID)).toBe(
      "0xae4984e3c1f0b73c2e160b899295e4a2d44b2229f23bdb7b8eccbbbcb0ba7d93"
    );
  });
  ...
  it("should pack L1 conversion message", () => {
    ...
    expect(bufferToHex(justification)).toBe(
      "0x32858f45b192eeb190e643f6915d45f832def5d2021b77b151867ec29843af18"
    );
  });
  ...
  it("should create new subnet to L1 conversion", () => {
    const subnetConversionID = utils.base58check.decode(
      "PFWYqXhRtrKGRvnSwCpxMXKa9d1pHmY8ASzu8mRCCBCb25p17"
    );
