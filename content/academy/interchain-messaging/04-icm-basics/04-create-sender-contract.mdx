...
To get the blockchainID of the Fuji C-Chain, you can use the following value:

```
BlockchainID (HEX): 0x9f3be606497285d0ffbb5ac9ba24aa60346a9b1812479ed66cb329f394a4b1c7
```
