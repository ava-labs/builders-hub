...
description: "Chainkit SDK documentation for block chain id"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/blockchainid.md
---
...
```typescript
import { BlockchainId } from "@avalanche-sdk/chainkit/models/components";
