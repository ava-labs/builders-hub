...
export const FIELD_LABELS: Record<string, { label: string; section: string }> = {
  ...
  'main.total_prizes':              { label: 'Total Prizes',             section: 'Basic Info' },
  ...
  'content.join_custom_link':       { label: 'Join Custom Link',         section: 'Content' },
  'content.submission_custom_link': { label: 'Submission Custom Link',   section: 'Content' },
