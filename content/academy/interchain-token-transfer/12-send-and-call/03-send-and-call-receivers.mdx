...
```solidity title="lib/ictt/contracts/src/interfaces/IERC20SendAndCallReceiver.sol"
/**
...
```solidity title="lib/ictt/contracts/src/interfaces/INativeSendAndCallReceiver.sol"
/**
