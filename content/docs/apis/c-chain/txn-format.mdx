...
transactions in `Coreth`. This document uses the [primitive serialization](/docs/apis/standards/serialization-primitives) format for packing and
[secp256k1](/docs/apis/standards/cryptographic-primitives#cryptography-in-the-avalanche-virtual-machine)
