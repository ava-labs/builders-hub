            ...
            {deployerConfig.activated && (
              <div className="mt-2">
                <AllowlistPrecompileConfigurator
                  title=""
                  description={
                    compact ? '' : 'Configure Admin, Manager, and Enabled roles for contract deployment permissions.'
                  }
            ...
            {txConfig.activated && (
              <div className="mt-2">
                <AllowlistPrecompileConfigurator
                  title=""
                  description={
                    compact ? '' : 'Set Admin, Manager, and Enabled roles to control transaction submission rights.'
                  }
            ...
            {nativeMinterConfig.activated && (
              <div className="mt-2">
                <AllowlistPrecompileConfigurator
                  title=""
                  description={
                    compact ? '' : 'Assign Admin, Manager, and Enabled roles for native token minting authority.'
                  }
