...
[Go to this step →](/academy/permissionless-l1s/05-staking-manager-setup/02-deploy-staking-manager)
...
[Go to this step →](/academy/permissionless-l1s/05-staking-manager-setup/03-deploy-reward-calculator)
...
[Go to this step →](/academy/permissionless-l1s/05-staking-manager-setup/04-initialize-staking-manager)
...
[Go to this step →](/academy/permissionless-l1s/05-staking-manager-setup/05-enable-native-minter)
...
[Go to this step →](/academy/permissionless-l1s/05-staking-manager-setup/06-transfer-ownership)
...
[Go to this step →](/academy/permissionless-l1s/05-staking-manager-setup/07-read-contract)
