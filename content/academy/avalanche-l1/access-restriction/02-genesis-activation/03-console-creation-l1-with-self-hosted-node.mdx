---
title: L1 Creation 
description: "Create an L1 with Transaction and Contract Deployer Precompiles enabled(using self-hosted node) "
updated: 2025-12-10
...
- [BuilderHub account](https://build.avax.network/login) (create one if needed)
