...
const StakeERC20: React.FC<BaseConsoleToolProps> = ({ onSuccess }) => {
            ...
            <div className="space-y-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-2 border-blue-500">
                    ...
                    <div className="text-xs text-zinc-600 dark:text-zinc-400">
                        You are staking with custom ERC20 tokens
                    </div>
                </div>
                ...
                <Steps>
                    <Step>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            Choose the L1 subnet where you want to register a validator with ERC20 Token staking.
                        </p>
                    ...
                    <Step>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            Register your validator on the staking manager contract and lock your ERC20 token stake.
