import { Validator, SubnetInfo } from "./types";
import { pChainEndpoint } from "./consts";
import { AvaCloudSDK } from "@avalabs/avacloud-sdk";

// Create SDK instance with testnet flag
// Note: callers should pass the isTestnet flag from useWalletStore()
export function createAvaCloudSDK(isTestnet: boolean) {
...
// Default SDK instance for backwards compatibility (defaults to mainnet)
