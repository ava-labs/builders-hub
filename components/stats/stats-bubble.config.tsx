...
import { Globe, List, ChartArea, Command, MessageCircleMore, Landmark } from "lucide-react";
...
export const statsBubbleConfig: BubbleNavigationConfig = {
  items: [
    ...
    { id: "rwa", label: "RWA", href: "/stats/rwa", icon: Landmark },
  ],
...
const getActiveItem = (
  ...
  if (currentItem) {
    ...
    return "playground";
  } else if (pathname.startsWith("/stats/rwa")) {
    return "rwa";
  }
  return "overview";
};
