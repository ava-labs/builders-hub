...
function DeployProxyContract({ onSuccess }: BaseConsoleToolProps) {
  ...
  return (
    <>
      ...
      <p className="mb-3">
        <strong>How It Works:</strong> The proxy contract stores state and forwards function calls, while the
        implementation contract contains only the logic. The proxy admin manages implementation upgrades securely.
      </p>
