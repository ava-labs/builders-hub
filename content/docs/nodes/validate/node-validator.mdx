...
[Avalanche's Postman collection](/docs/tooling/avalanche-postman/add-postman-collection) 
...
Get this info by calling [`info.getNodeID`](/docs/apis/info-api#infogetnodeid):
...
Calling
[`platform.getPendingValidators`](/docs/apis/p-chain/api#platformgetpendingvalidators)
...
[`platform.getTxStatus`](/docs/apis/p-chain/api#platformgettxstatus)
