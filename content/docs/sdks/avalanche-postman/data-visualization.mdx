...
- [`eth_baseFee`](/docs/apis/c-chain/api#eth_basefee)
...
- [`avax.getAtomicTx`](/docs/apis/c-chain/api#avaxgetatomictx)

### P-Chain[​](#p-chain "Direct link to heading")

- [`platform.getCurrentValidators`](/docs/apis/p-chain/api#platformgetcurrentvalidators)

### X-Chain[​](#x-chain "Direct link to heading")

- [`avm.getAssetDescription`](/docs/apis/x-chain/api#avmgetassetdescription)
- [`avm.getBlock`](/docs/apis/x-chain/api#avmgetblock)
- [`avm.getBlockByHeight`](/docs/apis/x-chain/api#avmgetblockbyheight)
- [`avm.getTx`](/docs/apis/x-chain/api#avmgettx)
