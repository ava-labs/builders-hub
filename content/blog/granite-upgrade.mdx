...
The Mainnet [release](https://github.com/ava-labs/avalanchego/releases/tag/v1.14.0) for the latest upgrade to the Avalanche Network, dubbed "Avalanche Granite", has been published. The Mainnet activation is scheduled for **November 19th, 2025 at 11 AM ET (3 PM UTC)**.

**_Action Required_: All Mainnet node operators must upgrade their nodes to v1.14 before the scheduled activation time or risk operational failure.** For instructions on upgrading your node, see [this guide](REPLACE-LINK-SCRIPT-BLOG).
...
**Action Required**: All Mainnet node operators must upgrade their nodes to **v1.14** before **11 AM ET (3 PM UTC) on November 19th, 2025**.
...
For a step-by-step guide on upgrading your node, see [this article](REPLACE-LINK-SCRIPT-BLOG) on using the installer script.
