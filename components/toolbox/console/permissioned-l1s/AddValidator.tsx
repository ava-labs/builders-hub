...
const AddValidatorExpert: React.FC<BaseConsoleToolProps> = ({ onSuccess }) => {
  ...
  const [isValidatorManagerDetailsExpanded, setIsValidatorManagerDetailsExpanded] =
  ...
  return (
    <>
      <div className="space-y-6">
        ...
        <Steps>
          <Step>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Before adding a validator, you must have an L1 node set up and running. If you haven't
              done this yet, visit the{" "}
              <Link
          ...
          <Step>
            ...
            <ValidatorListInput
              ...
              l1TotalInitializedWeight={
                !l1WeightError && contractTotalWeight > 0n ? contractTotalWeight : null
              }
          ...
          <Step>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Call the{" "}
              <a
                href="https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L308"
                target="_blank"
              ...
              function on the Validator Manager contract. This transaction will emit a{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#registerl1validatormessage"
                className="text-blue-600 hover:text-blue-800 underline"
              >
          ...
          <Step>
            ...
            <p className="text-sm text-gray-500 mb-4">
              ...
              and submit a{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#registerl1validatortx"
                className="text-blue-600 hover:text-blue-800 underline"
              >
                RegisterL1ValidatorTx
              </Link>{" "}
              to P-Chain. This transaction will emit a{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#l1validatorregistrationmessage"
                className="text-blue-600 hover:text-blue-800 underline"
              >
          ...
          <Step>
            <h2 className="text-lg font-semibold">
              Sign L1ValidatorRegistrationMessage & Submit completeValidatorRegistration on
              Validator Manager contract
            </h2>
            <p className="text-sm text-gray-500 mb-4">
              Complete the validator registration by signing the P-Chain{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#l1validatorregistrationmessage"
                className="text-blue-600 hover:text-blue-800 underline"
              >
              ...
              and calling the{" "}
              <a
                href="https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L425"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-blue-800 underline"
              >
              ...
              function on the Validator Manager contract.
            </p>
            <CompleteValidatorRegistration
        ...
        {globalSuccess && <Success label="Process Complete" value={globalSuccess} />}
