  ...
  useEffect(() => {
    ...
    const checkAndInject = () => {
      ...
      toggleButton.setAttribute(
        "aria-label",
        isAcademyPage ? "Toggle academy sidebar" : "Toggle docs sidebar"
      );
      toggleButton.setAttribute("type", "button");
      toggleButton.className =
        "flex items-center justify-center w-10 h-10 rounded-md border border-border hover:bg-accent transition-colors shrink-0 mr-3";
        ...
        (e) => {
          ...
          setTimeout(() => {
            ...
            const sidebarToggleButton = document.querySelector(
              'button[aria-label*="sidebar" i]:not([data-docs-sidebar-toggle]), button[aria-label*="Open Sidebar" i]:not([data-docs-sidebar-toggle])'
              ...
              requestAnimationFrame(() => {
                ...
                setTimeout(() => {
                  try {
                    ...
                    sidebarToggleButton.addEventListener("click", preventNav, {
                      once: true,
                      capture: true,
                    });
            ...
            const notebookButtons = document.querySelectorAll(
              '.nd-layout-notebook button:not([data-docs-sidebar-toggle]):not([aria-haspopup]):not([role="combobox"])'
            );
