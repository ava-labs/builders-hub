...
You can find the Fee Manager implementation in the [subnet-evm repository](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/precompile/contracts/feemanager/contract.go).
