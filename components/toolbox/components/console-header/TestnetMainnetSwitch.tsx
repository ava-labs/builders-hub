  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-30">
        <DropdownMenuItem onClick={() => safelySwitch(avalancheFuji.id, true)}>Testnet</DropdownMenuItem>
        <DropdownMenuItem onClick={() => safelySwitch(avalanche.id, false)}>Mainnet</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
}
