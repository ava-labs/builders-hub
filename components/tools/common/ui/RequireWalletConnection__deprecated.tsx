 ...
 */
export default function RequireWalletConnection({
  children,
  chainConfig,
  requiredBalance,
  onConnection,
    ...
    switch (connectionStatus) {
      case "no_wallet_installed":
        return (
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            ...
            <p className="mb-4">
              You need a Web3 wallet to interact with your L1 chain. We recommend installing Core
              wallet:
            </p>
            <a
      ...
      case "wrong_chain":
        return (
          <div>
            ...
            <p className="mb-4">
              You need to add and connect the {chainConfig.chainName} chain to your wallet to
              continue.
            </p>
      ...
      case "insufficient_balance":
        return (
          <>
            <p>
              The balance of the account {account} is {accountBalance?.toFixed(4)}{" "}
              {chainConfig.nativeCurrency.symbol}. That is lower than the required balance of{" "}
              {requiredBalance} {chainConfig.nativeCurrency.symbol}. Please fund your account to
              proceed.
            </p>
            <button
              onClick={checkConnection}
