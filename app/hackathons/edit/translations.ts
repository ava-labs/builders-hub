export const t = {
  en: {
    ...
    googleCalendarIdHelp: 'Public Google Calendar ID that contains your event schedule. The event page will display events from this calendar. Leave empty to manage schedule manually below.',
    schedule: 'Schedule',
    scheduleHelp: 'Add events manually below, or use a Google Calendar ID above to pull events automatically. Examples: Team Formation, Workshop: Mastering Avalanche, etc.',
  ...
  es: {
    ...
    googleCalendarIdHelp: 'ID de un Google Calendar público que contenga la agenda del evento. La página del evento mostrará los eventos de este calendario. Déjalo vacío para gestionar la agenda manualmente abajo.',
    schedule: 'Agenda',
    scheduleHelp: 'Añade eventos manualmente abajo o usa un ID de Google Calendar arriba para cargar los eventos automáticamente. Ejemplos: Formación de Equipos, Taller: Dominando Avalanche, etc.',
