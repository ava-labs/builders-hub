...
- Rewards are calculated by the [RewardCalculator](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/interfaces/IRewardCalculator.sol) contract, which you deployed during the [Staking Manager Setup](/academy/permissionless-l1s/05-staking-manager-setup/04-deploy-reward-calculator)
