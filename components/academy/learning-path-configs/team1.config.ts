...
export const team1LearningPaths: CourseNode[] = [
    ...
    {
        id: "team1-event-organizer-pro",
        name: "Team1 Event Organizer Pro",
        description: "Scale into series, volunteers, partnerships, content reuse, and durable community outcomes.",
        slug: "team1/team1-event-organizer-pro",
        category: "Community",
        dependencies: ["team1-organizing-first-event"],
        position: { x: 80, y: 400 },
        mobileOrder: 5
    },
    {
