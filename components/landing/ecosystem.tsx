...
const ecosystem = [
  ...
  },
  {
    ...
    description: "Discover and try out different applications and L1s in the Avalanche ecosystem.",
          ...
          {ecosystem.map((item, index) => (
            <Link
              ...
              className={cn(
                ...
                index === 1 &&
                  "lg:border-x-0 lg:border-l lg:border-r dark:lg:border-l-[rgba(255,255,255,0.08)] dark:lg:border-r-[rgba(255,255,255,0.08)]"
              )}
            >
              {/* Premium hover glow */}
              ...
              <div className="relative z-10 p-8 lg:p-10 h-full min-h-[240px] flex flex-col justify-between">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-4 mb-6">
                    ...
                    />
                    <div
                      className="p-2 rounded-full bg-gray-100/80 dark:bg-[rgba(255,255,255,0.06)] 
                ...
                {/* CTA */}
                <div
                  className="flex items-center text-gray-800 dark:text-slate-300 font-medium 
