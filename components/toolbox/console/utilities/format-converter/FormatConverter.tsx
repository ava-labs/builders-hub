    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-4 p-4 bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700">
          ...
          {cb58ToHexResult && !cb58ToHexError && <CopyableSuccess label="Hex Result" value={cb58ToHexResult} />}
        </div>
        ...
        <div className="space-y-4 p-4 bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700">
          ...
          />
          <Button onClick={handleCb58ToHexWithChecksumConvert} variant="primary">
            Convert
          </Button>
        ...
        <div className="space-y-4 p-4 bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700">
          ...
          {cleanHexResult && <CopyableSuccess label="Formatted Hex Result" value={cleanHexResult} />}
        </div>
        ...
        <div className="space-y-4 p-4 bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700">
          ...
          {unformatHexResult && <CopyableSuccess label="Unformatted Hex Result" value={unformatHexResult} />}
        </div>
      </div>
    </Container>
  );
