...
This command and all of its flags are documented [here](/docs/tooling/avalanche-cli#key-transfer).
...
After a successful transfer, you can check your CLI keys' balances with the [command](/docs/tooling/avalanche-cli#key-list): `avalanche key list`.
