...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmgetaccountpubkey)
...
- [API Reference](https://build.avax.network/docs/api-reference/x-chain/api#avmsignmessage)
- [signXPTransaction](#signxptransaction) - Sign transactions
