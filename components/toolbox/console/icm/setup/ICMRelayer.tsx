      ...
      <Steps>
        ...
        <Step>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <ConfigPreview configJson={configJson} highlightedLines={highlightedLines} />
          </div>
        </Step>
        ...
        <Step>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            The relayer will monitor the source blockchains for cross-chain messages and deliver
            them to the destination blockchains.
          </p>
        </Step>
      </Steps>
    </div>
