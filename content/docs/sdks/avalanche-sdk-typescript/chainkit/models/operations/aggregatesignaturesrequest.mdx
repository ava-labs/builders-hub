---
title: "Aggregate Signatures Request"
description: "Chainkit SDK documentation for aggregate signatures request"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/operations/aggregatesignaturesrequest.md
---
...
```typescript
import { AggregateSignaturesRequest } from "@avalanche-sdk/chainkit/models/operations";
...
| `signatureAggregatorRequest`                                                                   | [components.SignatureAggregatorRequest](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/signatureaggregatorrequest.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |                                                                                                |