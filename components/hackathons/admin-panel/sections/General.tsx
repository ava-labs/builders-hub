...
function General({ form }: { form: UseFormReturn<z.infer<typeof hackathonAdminFormSchema>> }) {
  return (
    <>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-zinc-400">
                This is the name that will be displayed on the public hackathon page.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-zinc-400">
                Keep it concise and clear (Max: 500 characters). Focus on objectives, themes, and
                any unique aspects of the hackathon.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-zinc-400">
                ...
                • Recommended size: 1270 &times; 760px <br />• Max file size: 2MB
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="virtual">Virtual (Participants join online)</SelectItem>
                  <SelectItem value="hybrid">Hybrid (Both on-site and virtual options)</SelectItem>
                </SelectContent>
              </Select>
              <FormDescription className="text-zinc-400">
                Choose whether the hackathon will be held virtual, on-site, or in a hybrid format.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-zinc-400">
                Specify the exact location if it&apos;s an on-site or hybrid hackathon.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription className="text-zinc-400">
                Set the last date and time for participant registration. Must be before the
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription className="text-zinc-400">
                Set the official start date and time of the hackathon. Must be after the
                registration deadline.
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-zinc-400">
                Select the official time zone for event scheduling. This will affect deadlines and
                submission times.
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-zinc-400">
                Public events are visible to everyone. Private events require an invitation.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="live">Live (Currently active and visible)</SelectItem>
                  <SelectItem value="ended">Ended (Hackathon has concluded)</SelectItem>
                </SelectContent>
              </Select>
              <FormDescription className="text-zinc-400">
                Select the current state of the hackathon. <br /> The status updates automatically
                based on the selected dates. You can override it manually if needed.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
