      ...
      <div className="space-y-6">
        ...
        <Steps>
          ...
          <Step>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Start the weight change process by specifying the validator and new weight and calling
              the{" "}
              <a
                href="https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L642"
                target="_blank"
              ...
              function on the Validator Manager contract. This transaction will emit an{" "}
              <Link
          ...
          <Step>
            <h2 className="text-lg font-semibold">
              Sign L1ValidatorWeightMessage & Submit SetL1ValidatorWeightTx to P-Chain
            </h2>
            <p className="text-sm text-gray-500 mb-4">
              Sign the{" "}
              <Link
          ...
          <Step>
            <h2 className="text-lg font-semibold">
              Sign P-Chain L1ValidatorWeightMessage & Submit completeValidatorWeightUpdate on
              Validator Manager contract
            </h2>
            <p className="text-sm text-gray-500 mb-4">
              Complete the weight change by signing the P-Chain{" "}
              <Link
                href="/docs/acps/77-reinventing-subnets#l1validatorweightmessage"
                className="text-blue-600 hover:text-blue-800 underline"
              >
              ...
              and calling the{" "}
              <a
                href="https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/ValidatorManager.sol#L690"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-blue-800 underline"
              >
