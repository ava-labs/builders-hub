...
or `P-Chain`. This document uses the [primitive serialization](/docs/apis/standards/serialization-primitives) format for packing and
...
A [secp256k1](/docs/apis/standards/cryptographic-primitives#secp256k1-addresses) output owners
