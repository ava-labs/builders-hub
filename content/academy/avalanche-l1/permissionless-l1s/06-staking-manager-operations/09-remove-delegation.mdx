...
The delegator calls [`initiateDelegatorRemoval(delegationID)`](https://github.com/ava-labs/icm-services/blob/main/icm-contracts/avalanche/validator-manager/PoSValidatorManager.sol) on the Staking Manager contract.
...
Call [`completeDelegatorRemoval(messageIndex)`](https://github.com/ava-labs/icm-services/blob/main/icm-contracts/avalanche/validator-manager/PoSValidatorManager.sol) with the P-Chain's signed response:
