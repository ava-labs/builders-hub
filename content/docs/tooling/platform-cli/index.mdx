...
1. [Install Platform CLI](/docs/tooling/platform-cli/installation) and build from source
...
<Cards>
  ...
  <Card title="Subnets & L1s" href="/docs/tooling/platform-cli/subnets-and-l1s">
