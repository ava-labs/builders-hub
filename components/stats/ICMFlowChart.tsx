...
export default function ICMFlowChart({
  ...
  const height = isMobile ? Math.max(400, Math.min(width * 0.9, 500)) : propHeight || 550;
    ...
    >
      ...
      >
        ...
        <g transform={`translate(${padding.left},${padding.top})`}>
          {/* Background grid */}
          <rect width={chartWidth} height={chartHeight} fill="url(#icm-grid)" opacity="0.5" />
              ...
              return (
                <g key={i} className="link-group">
                  <path
                    ...
                    strokeWidth={strokeW}
                    opacity={
                      hoveredFlow !== null || hoveredNode !== null ? (isHovered ? 0.9 : 0.15) : 0.55
                    }
                    style={{
