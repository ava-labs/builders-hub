---
title: "Erc Transfer"
description: "Chainkit SDK documentation for erc transfer"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/erctransfer.md
---
...
```typescript
import { ERCTransfer } from "@avalanche-sdk/chainkit/models/components";
...
| `erc20Token`                                                       | [components.ERCToken](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/erctoken.md)         | :heavy_minus_sign:                                                 | erc20 Token details                                                |                                                                    |
| `erc721Token`                                                      | [components.ERCToken](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/erctoken.md)         | :heavy_minus_sign:                                                 | erc721 Token details                                               |                                                                    |
| `erc1155Token`                                                     | [components.ERCToken](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/erctoken.md)         | :heavy_minus_sign:                                                 | erc1155 Token details                                              |                                                                    |