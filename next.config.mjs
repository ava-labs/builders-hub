...
const config = {
  ...
  async redirects() {
    return [
      ...
      {
        source:
          '/academy/avalanche-l1/interchain-messaging/08-securing-cross-chain-communication/01-securing-cross-chain-communication',
      ...
      },
      {
        ...
        destination:
          '/academy/avalanche-l1/interchain-messaging/10-running-a-relayer/02-relayer-configuration#multichain-relayer-configuration',
        permanent: true,
      },
      {
      ...
      {
        source:
          '/docs/build/tutorials/nodes-and-staking/staking-avax-by-validating-or-delegating-with-the-avalanche-wallet',
        destination: '/docs/primary-network/validate/how-to-stake',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          '/academy/avalanche-l1/customizing-evm/05-genesis-configuration/08-build-and-run-custom-genesis-blockchain',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          '/academy/avalanche-l1/avalanche-fundamentals/03-multi-chain-architecture-intro/04-custom-blockchains-vs-layer-2',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: '/academy/avalanche-l1/l1-native-tokenomics/01-tokens-fundamentals/01-introduction',
        permanent: true,
      },
      {
        source: '/academy/avalanche-l1/l1-native-tokenomics/02-custom-native-tokens',
        destination: '/academy/avalanche-l1/l1-native-tokenomics/02-custom-tokens/01-introduction',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: '/academy/avalanche-l1/l1-native-tokenomics/02-custom-tokens/02-custom-native-vs-erc20-native',
        permanent: true,
      },
      {
