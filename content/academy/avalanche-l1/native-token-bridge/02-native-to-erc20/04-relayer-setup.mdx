...
description: Deploy ICM contracts and set up a relayer between your L1 and Fuji C-Chain.
updated: 2025-12-17
...
Now set up a relayer between your **L1** and **Fuji C-Chain** to deliver cross-chain messages.
