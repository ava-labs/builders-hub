...
You can find the Reward Manager implementation in the [subnet-evm repository](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/precompile/contracts/rewardmanager/contract.go).
