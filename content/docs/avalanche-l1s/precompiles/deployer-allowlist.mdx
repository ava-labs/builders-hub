...
You can find the implementation in the [subnet-evm repository](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/precompile/contracts/deployerallowlist/contract.go).
