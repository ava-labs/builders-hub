...
See the [platform-cli command reference](/docs/tooling/platform-cli/command-reference) for all available node commands.
...
[`platform.getCurrentValidators`](/docs/rpcs/p-chain#platformgetcurrentvalidators)
once the validation period has started.
