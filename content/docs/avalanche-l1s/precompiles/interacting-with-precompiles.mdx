...
3. Enable **Testnet Mode** (if using testnet):
   - Open Core extension
   - Click the **Tools** icon in the sidebar → **Settings**
...
- [IFeeManager.sol](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/contracts/contracts/interfaces/IFeeManager.sol) - For fee configuration
- [INativeMinter.sol](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/contracts/contracts/interfaces/INativeMinter.sol) - For minting native tokens
- [IAllowList.sol](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/contracts/contracts/interfaces/IAllowList.sol) - For transaction/deployer allowlists
- [IRewardManager.sol](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/contracts/contracts/interfaces/IRewardManager.sol) - For block rewards
...
- [Subnet-EVM Contracts](https://github.com/ava-labs/avalanchego/tree/master/graft/subnet-evm/contracts/contracts/interfaces) - Precompile interfaces
