...
export const TransactionFeesSection = ({
  ...
  feeConfig,
  setFeeConfig,
  feeManagerEnabled: _feeManagerEnabled,
  setFeeManagerEnabled: _setFeeManagerEnabled,
  feeManagerAdmins: _feeManagerAdmins,
  setFeeManagerAdmins: _setFeeManagerAdmins,
  rewardManagerEnabled: _rewardManagerEnabled,
  setRewardManagerEnabled: _setRewardManagerEnabled,
  rewardManagerAdmins: _rewardManagerAdmins,
  setRewardManagerAdmins: _setRewardManagerAdmins,
  validationMessages,
  compact,
