...
| Parameter | Validator | Delegator |
|-----------|-----------|-----------|
| **Minimum Stake Amount** | 2,000 AVAX | 25 AVAX |
| **Minimum Staking Time** | 2 weeks | 2 weeks |
| **Maximum Staking Time** | 1 year | 1 year |
| **Minimum Delegation Fee Rate** | 2% | N/A |
| **Maximum Validator Weight** | 3 million AVAX or 5x validator's own stake (whichever is lower) | N/A |

<Callout type="info">
**Validator Weight Example**: If you stake 2,000 AVAX as a validator, the maximum total weight (your stake + delegated stake) is 10,000 AVAX (5 × 2,000), so only 8,000 AVAX can be delegated to your node in total.
</Callout>
...
| Parameter | Validator | Delegator |
|-----------|-----------|-----------|
| **Minimum Stake Amount** | 1 AVAX | 1 AVAX |
| **Minimum Staking Time** | 24 hours | 24 hours |
