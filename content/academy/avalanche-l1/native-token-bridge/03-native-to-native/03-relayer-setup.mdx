---
title: Relayer Setup
description: Set up a hosted ICM relayer between Fuji C-Chain and your new L1 so native-token bridging messages get delivered.
updated: 2025-12-17
...
Native-token bridging uses Interchain Messaging under the hood, so you need a relayer between **Fuji C-Chain** and your **new L1** to deliver cross-chain messages.
