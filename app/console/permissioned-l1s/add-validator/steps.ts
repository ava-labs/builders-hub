...
import EnsureNodeStep from "@/components/toolbox/console/permissioned-l1s/AddValidator/steps/EnsureNodeStep";
...
export const steps: StepDefinition[] = [
  { type: "single", key: "ensure-node", title: "Ensure Node Running", component: EnsureNodeStep },
