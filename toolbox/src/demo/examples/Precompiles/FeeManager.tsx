...
import { AllowListWrapper } from "../../../toolbox/components/AllowListComponents";
...
function FeeManagerComponent() {
  const { setFeeConfig, getFeeConfig, getFeeConfigLastChangedAt } =
    useFeeManager();
  ...
  return (
    <RequireChain chain={avalancheFuji}>
      <div className="space-y-6">
        ...
        >
          <AllowListWrapper precompileAddress={FEE_MANAGER_ADDRESS} />
        </Container>
      </div>
    </RequireChain>
  );
