---
title: "Webhookaddressactivity Response"
description: "Chainkit SDK documentation for webhookaddressactivity response"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/webhookaddressactivityresponse.md
---
...
```typescript
import { WebhookAddressActivityResponse } from "@avalanche-sdk/chainkit/models/components";
...
| `eventType`                                                                                                              | [components.WebhookAddressActivityResponseEventType](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/webhookaddressactivityresponseeventtype.md) | :heavy_check_mark:                                                                                                       | Event type                                                                                                               | address_activity                                                                                                         |
| `messageId`                                                                                                              | *string*                                                                                                                 | :heavy_check_mark:                                                                                                       | Message ID                                                                                                               | bc9732db-2430-4296-afc3-c51267beb14a                                                                                     |
| `event`                                                                                                                  | [components.TransactionEvent](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/transactionevent.md)                                               | :heavy_check_mark:                                                                                                       | Event details                                                                                                            |                                                                                                                          |