---
title: "Subnet"
description: "Chainkit SDK documentation for subnet"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/subnet.md
---
...
```typescript
import { Subnet } from "@avalanche-sdk/chainkit/models/components";
...
| `subnetOwnershipInfo`                                                                                                                                                               | [components.SubnetOwnershipInfo](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/subnetownershipinfo.md)                                                                                                    | :heavy_check_mark:                                                                                                                                                                  | Latest subnet owner details for this Subnet.                                                                                                                                        |
...
| `l1ValidatorManagerDetails`                                                                                                                                                         | [components.L1ValidatorManagerDetails](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/l1validatormanagerdetails.md)                                                                                        | :heavy_minus_sign:                                                                                                                                                                  | L1 validator manager details.                                                                                                                                                       |
