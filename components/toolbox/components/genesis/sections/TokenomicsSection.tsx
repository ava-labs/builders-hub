...
export const TokenomicsSection = ({
  ...
  return (
    <SectionWrapper
      ...
      titleTooltipLink={{
        href: "/docs/avalanche-l1s/evm-configuration/tokenomics",
        text: "Learn more about tokenomics",
      }}
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {validationErrors.tokenAllocations && (
            <p className="text-red-500 text-sm mt-1">{validationErrors.tokenAllocations}</p>
          )}
        </div>
