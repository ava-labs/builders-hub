---
title: "Log"
description: "Chainkit SDK documentation for log"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/log.md
---
...
```typescript
import { Log } from "@avalanche-sdk/chainkit/models/components";
