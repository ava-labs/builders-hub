...
If you want to test out your production environment, running beyond 3 days, or anything more complex; you should run nodes on your own infrastructure using Docker:
