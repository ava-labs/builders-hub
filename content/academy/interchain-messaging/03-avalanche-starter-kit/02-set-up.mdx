...
Never share your private key with anyone or commit it to version control. Keep it secure and backed up.
</Callout>
...
TELEPORTER_REGISTRY_FUJI_DISPATCH=your_dispatch_registry_address
TELEPORTER_REGISTRY_FUJI_C_CHAIN=your_c_chain_registry_address
...
<Callout type="warning">
The private key is for testing only. Never use it in production or share it with anyone.
</Callout>
