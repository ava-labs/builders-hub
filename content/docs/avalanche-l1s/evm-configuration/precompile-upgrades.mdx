...
- [`eth_getActiveRulesAt`](/docs/apis/subnet-evm-api#eth_getactiverulesat) RPC method to check activated precompiles at a timestamp
- [`eth_getChainConfig`](/docs/apis/subnet-evm-api#eth_getchainconfig) RPC method to view the complete configuration including upgrades 
