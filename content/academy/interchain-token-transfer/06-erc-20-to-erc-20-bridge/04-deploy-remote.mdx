...
Before deploying the remote contract, ensure you have some test DIS, head to the [Avalanche Faucet](https://core.app/tools/testnet-faucet/?subnet=echo&token=dispatch) and claim some DIS tokens on the Dispatch of the Fuji testnet.
