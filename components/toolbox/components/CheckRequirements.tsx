...
import {
  useAccountRequirements,
  AccountRequirementsConfigKey,
} from "../hooks/useAccountRequirements";
...
export const CheckRequirements = ({ children, toolRequirements }: CheckRequirementsProps) => {
  ...
  const allRequirementsMet =
    walletRequirementsData.allRequirementsMet && accountRequirementsData.allRequirementsMet;
                      ...
                      if (requirement.alternativeActions) {
                        requirement.alternativeActions.forEach((altAction) => {
                          ...
                          if (!uniqueActions.has(altActionKey)) {
                            ...
                            uniqueActions
                              .get(altActionKey)
                              .relatedRequirements.push(requirement.title);
                          }
                        });
                      }
                    });
