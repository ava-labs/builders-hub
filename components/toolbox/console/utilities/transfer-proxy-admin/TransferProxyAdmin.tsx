...
function TransferProxyAdmin({ onSuccess }: BaseConsoleToolProps) {
    ...
    const canTransfer = !!proxyAdminAddress && !!newOwner && currentOwner?.toLowerCase() !== newOwner?.toLowerCase();
        ...
        <>
            <Steps>
                ...
                <Step>
                    ...
                    >
                        {!canTransfer ? (currentOwner?.toLowerCase() === newOwner?.toLowerCase() ? "Already Current Owner" : "Enter New Owner Address") : "Transfer Ownership"}
                    </Button>
