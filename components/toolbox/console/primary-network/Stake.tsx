...
const metadata: ConsoleToolMetadata = {
  ...
  description:
    "Stake AVAX as a validator on Avalanche's Primary Network to secure the network and earn rewards",
...
function Stake({ onSuccess }: BaseConsoleToolProps) {
  ...
  const [delegatorRewardPercentage, setDelegatorRewardPercentage] = useState<string>(
    DEFAULT_DELEGATOR_REWARD_PERCENTAGE
  );
  ...
  return (
    <>
      <div className="space-y-6">
        <Steps>
          <Step>
            ...
            <Alert variant="info" className="mt-4">
              <strong>Note:</strong> This step queries your <code>info.getNodeID</code> endpoint at{" "}
              <code>127.0.0.1:9650</code>. Make sure you have an AvalancheGo node running locally
              before proceeding.
              <br />
              If your node runs on a remote server, replace <code>127.0.0.1</code> with your node’s
              public IP in the command.
            </Alert>
              ...
              <div className="mt-4 p-4 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="font-mono text-xs text-zinc-700 dark:text-zinc-300 break-all">
                      {validator.nodePOP.proofOfPossession}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Step>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Input
                ...
                error={
                  error &&
                  (Number(delegatorRewardPercentage) < 2 || Number(delegatorRewardPercentage) > 100)
          ...
          <Step>
            ...
            <Input
              ...
              error={(() => {
                ...
                const d =
                  Math.floor(new Date(endTime).getTime() / 1000) - Math.floor(Date.now() / 1000);
        ...
        {/* Success Message */}
        {txId && <Success label="Transaction Submitted" value={txId} isTestnet={isTestnet} />}
