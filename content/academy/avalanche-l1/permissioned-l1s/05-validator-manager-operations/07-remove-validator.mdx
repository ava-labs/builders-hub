...
The owner calls [`initiateValidatorRemoval(validationID)`](https://github.com/ava-labs/icm-services/blob/ce85313c71f90282b390e685cb652e9b0150a4ae/contracts/validator-manager/ValidatorManager.sol#L518) on `ValidatorManager`.
