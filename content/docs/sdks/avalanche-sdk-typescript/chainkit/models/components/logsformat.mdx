---
title: "Logsformat"
description: "Chainkit SDK documentation for logsformat"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/logsformat.md
---
...
```typescript
import { LogsFormat } from "@avalanche-sdk/chainkit/models/components";
...
| `requestType`                                                                  | [components.RequestType](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/requesttype.md)               | :heavy_check_mark:                                                             | The type of request made by the client.                                        |
...
| `metadata`                                                                     | [components.LogsFormatMetadata](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/logsformatmetadata.md) | :heavy_check_mark:                                                             | The metadata of the request.                                                   |