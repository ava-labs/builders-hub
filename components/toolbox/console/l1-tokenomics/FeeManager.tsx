...
function FeeManager({ onSuccess }: BaseConsoleToolProps) {
  ...
  const canSetFeeConfig = Boolean(walletEVMAddress && coreWalletClient && !isSettingConfig);
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              helperText={
                Number(minBaseFee) < 1_000_000_000 || Number(minBaseFee) > 500_000_000_000
                  ? "Expected value between 1,000,000,000 and 500,000,000,000"
                  : undefined
              }
            />
            <Input
            ...
            <Input
              ...
              disabled={isSettingConfig}
              helperText={
                Number(minBlockGasCost) > 1_000_000_000
                  ? "Expected value between 0 and 1,000,000,000"
                  : undefined
              }
            />
            <Input
              ...
              disabled={isSettingConfig}
              helperText={
                Number(maxBlockGasCost) > 10_000_000_000
                  ? "Expected value between 0 and 10,000,000,000"
                  : undefined
              }
            />
            <Input
              ...
              disabled={isSettingConfig}
              helperText={
                Number(blockGasCostStep) > 5_000_000
                  ? "Expected value between 0 and 5,000,000"
                  : undefined
              }
            />
          </div>
        ...
        <div className="space-y-4">
          ...
          {currentConfig && (
            <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-md">
              <pre className="text-sm">{JSON.stringify(currentConfig, null, 2)}</pre>
            </div>
          )}
