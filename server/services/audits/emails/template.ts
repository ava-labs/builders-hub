  ...
  return `
    <div style="background-color: #18181B; color: #FAFAFA; font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 26px; border-radius: 12px; border: 1px solid #3F3F46;">
      <div>
        ...
        <span style="display: inline-block; vertical-align: middle; margin-left: 9px; font-family: 'Courier New', monospace; font-size: 10px; letter-spacing: 0.14em; color: #A2AFB2;">BUILDER HUB · AVA LABS AUDIT PROGRAM</span>
      </div>
