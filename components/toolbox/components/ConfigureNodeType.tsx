    ...
    <>
      ...
      {isRPC && (
        <div className="mt-6 space-y-4 border-t pt-4">
          ...
          <Checkbox label="Enable Debug & Trace APIs" checked={enableDebugTrace} onChange={setEnableDebugTrace} />
      ...
      {nodeType === 'validator' && (
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <ul className="list-disc pl-5 mt-2 text-sm space-y-1">
            <li>
              <strong>9651</strong> - Node-to-node communication
            </li>
          </ul>
        </div>
      )}
      ...
      {nodeType === 'public-rpc' && (
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <ul className="list-disc pl-5 mt-2 text-sm space-y-1">
            <li>
              <strong>443</strong> - HTTPS for public RPC access
            </li>
            <li>
              <strong>9650</strong> - RPC endpoint
            </li>
            <li>
              <strong>9651</strong> - Node-to-node communication
            </li>
