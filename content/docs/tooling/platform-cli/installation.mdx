...
curl -sSfL https://raw.githubusercontent.com/ava-labs/platform-cli/main/install.sh | sh -s -- -b ~/.local/bin

# Install a specific version
curl -sSfL https://raw.githubusercontent.com/ava-labs/platform-cli/main/install.sh | sh -s -- -v v0.2.0
```
