...
const Stake: React.FC<BaseConsoleToolProps> = ({ onSuccess }) => {
                ...
                <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            disabled={!!initiateRegistrationTxHash || !!completeRegistrationTxHash}
                            className={`flex-1 px-4 py-3 rounded-lg border-2 transition-all ${
                                tokenType === 'native'
                                    ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20'
                                    : 'border-zinc-200 dark:border-zinc-700 hover:border-zinc-300 dark:hover:border-zinc-600'
                            } ${(initiateRegistrationTxHash || completeRegistrationTxHash) ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                        >
                            <div className="text-left">
                                <div className="font-semibold text-sm">Native Token</div>
                                <div className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">
                                    Stake with L1 native tokens
                                </div>
                            </div>
                        </button>
                        <button
                        ...
                        >
                            <div className="text-left">
                                ...
                                <div className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">
                                    Stake with custom ERC20 tokens
                                </div>
                            </div>
                        </button>
                    </div>
                ...
                <Steps>
                    <Step>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            Choose the L1 subnet where you want to register a validator with {tokenLabel} staking.
                        </p>
                    ...
                    <Step>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                            Register your validator on the staking manager contract and lock your stake.
