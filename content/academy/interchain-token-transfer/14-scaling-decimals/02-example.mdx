...
- **Recommended:** Create a [Builder Hub account](https://build.avax.network/login) and connect your wallet to receive testnet tokens automatically, including USDC
- **Alternative:** Use the [external faucet](https://core.app/tools/testnet-faucet/?subnet=c&token=usdcc) to claim USDC on Fuji 
```bash
