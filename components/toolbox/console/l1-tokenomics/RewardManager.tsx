...
const StatusBadge = ({ status, loadingText, isLoading }: StatusBadgeProps) => {
  if (isLoading) {
    return <span className="text-sm text-muted-foreground">{loadingText || "Loading..."}</span>;
  }
...
const metadata: ConsoleToolMetadata = {
  ...
  description:
    "Manage reward settings for the network including fee recipients and reward addresses",
          ...
          <div className="space-y-4 p-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                {isFeeRecipientsAllowed !== null && <StatusBadge status={isFeeRecipientsAllowed} />}
              </div>
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                >
                  {isAllowingFeeRecipients ? "Processing..." : "Allow Fee Recipients"}
                </Button>
                <Button
                  variant="secondary"
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <Button
                  ...
                  disabled={!walletEVMAddress || isAnyOperationInProgress}
                >
                  {isCheckingRewardAddress ? "Checking..." : "Check Current Address"}
                </Button>
              </div>

              {currentRewardAddress && (
                <div className="bg-slate-50 border border-slate-200 rounded-md p-3">
                  <p className="text-sm font-medium text-slate-700">Current Reward Address</p>
                  <p className="text-xs font-mono break-all">{currentRewardAddress}</p>
                </div>
              )}
            ...
            <div className="space-y-4">
              ...
              >
                {isSettingRewardAddress ? "Processing..." : "Set Reward Address"}
              </Button>
