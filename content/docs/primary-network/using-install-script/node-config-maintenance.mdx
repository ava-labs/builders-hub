...
- `admin` - [Admin API](/docs/apis/admin-api) will be enabled
...
- `index` - [Index API](/docs/apis/index-api) will be enabled
...
The file that configures node operation is `~/.avalanchego/configs/node.json`. You can edit it to add or change configuration options. The documentation of configuration options can be found [here](/docs/primary-network/configure/configs-flags). Configuration may look like this:
...
The script also creates an empty C-Chain config file, located at `~/.avalanchego/configs/chains/C/config.json`. By editing that file, you can configure the C-Chain, as described in detail [here](/docs/primary-network/configure/configs-flags).
