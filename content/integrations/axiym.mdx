...
developer: Axiym
website: https://axiym.io/
documentation: https://axiym.io/
---
...
Through direct integrations with major payment networks including Terrapay, Lulu Financial, and others, Axiym uses blockchain-based liquidity to address the $150+ trillion cross-border payments industry by eliminating pre-funding requirements, enabling instant settlements, and reducing the working capital needed to operate payment corridors globally.
...
This shift from capital-intensive to capital-efficient payments is significant for the industry.
...
These partnerships show Axiym's ability to serve high-volume, institutional payment flows.

## Avalanche Integration

Axiym uses Avalanche's infrastructure for several key advantages:
...
Axiym uses stablecoins as settlement rails:
...
- **Liquidity APIs**: APIs for requesting liquidity on-demand
...
- **Reporting Tools**: Reporting for finance and compliance
...
Axiym addresses this market with an on-chain solution.
...
**Blockchain Infrastructure**: Using Avalanche and other networks for settlement.
