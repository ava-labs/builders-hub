...
- **Introduction** - review on what the P-Chain is, ICM for Validator Manager Contract & Proxy Patterns
...
- **Create an L1** - Creating a Subnet, understanding the genesis pre-deployed contracts and creating your L1 (recommended to first have created an L1 in the [Avalanche Fundamentals course](/academy/avalanche-fundamentals))
