...
func main() {
    ...
    err := tmpnet.BootstrapNewNetwork(
        ...
        "./build/avalanchego", // Path to avalanchego binary
...
err := tmpnet.BootstrapNewNetwork(ctx, os.Stdout, network, "", avalanchegoPath, pluginDir)
...
func TestWithTmpnet(t *testing.T) {
    ...
    err := tmpnet.BootstrapNewNetwork(ctx, t.Logf, network, "", avalanchegoPath, "")
    if err != nil {
...
var _ = Describe("My Feature", func() {
    ...
    BeforeEach(func() {
        ...
        err := tmpnet.BootstrapNewNetwork(ctx, GinkgoWriter, network, "", avalanchegoPath, "")
...
var _ = Describe("Feature Tests", func() {
    ...
    BeforeSuite(func() {
        ...
        err := tmpnet.BootstrapNewNetwork(ctx, GinkgoWriter, sharedNetwork, "", avalanchegoPath, "")
        Expect(err).NotTo(HaveOccurred())
    })
...
func createNetworks(count int) []*tmpnet.Network {
    ...
    for i := 0; i < count; i++ {
        ...
        go func(index int) {
            ...
            err := tmpnet.BootstrapNewNetwork(ctx, os.Stdout, network, "", avalanchegoPath, "")
...
err = tmpnet.BootstrapNewNetwork(bootstrapCtx, os.Stdout, network, "", avalanchegoPath, "")
```
