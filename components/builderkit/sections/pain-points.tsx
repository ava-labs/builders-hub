...
const PainPointCard = ({ point, theme }: { point: (typeof painPoints)[0]; theme: string }) => (
  ...
  >
    <div className="absolute inset-0 rounded-2xl bg-linear-to-br opacity-0 group-hover:opacity-100 transition-all duration-500 blur-xl" />
    <motion.div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <motion.h3 className="text-2xl font-semibold mb-4 group-hover:text-[#1f66f4] transition-colors duration-300">
          {point.title}
        </motion.h3>
