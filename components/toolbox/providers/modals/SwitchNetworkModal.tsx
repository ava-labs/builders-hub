                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center overflow-hidden shrink-0">
                      {network.logoUrl ? (
                        <img src={network.logoUrl} alt={network.name} className="w-8 h-8 rounded-full object-cover" />
                      ) : (
                        <span className="text-lg font-bold text-zinc-400">{network.name.charAt(0)}</span>
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-zinc-900 dark:text-zinc-100 truncate">{network.name}</span>
                        {network.isTestnet && (
