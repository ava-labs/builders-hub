...
import { blockchainDeveloperAcademyLandingPageConfig } from "./blockchain-developer.config";

export const metadata: Metadata = createMetadata({
  title: "Blockchain Developer Academy",
  description:
    "Master blockchain fundamentals and smart contract development from the ground up",
  openGraph: {
    url: "/blockchain-developer-academy",
    images: {
      url: "/api/og/academy",
      width: 1200,
      height: 630,
      alt: "Blockchain Developer Academy",
    },
  },
  twitter: {
    images: {
...
export default function BlockchainDeveloperAcademyPage(): React.ReactElement {
  ...
  return (
    <AcademyLayout
      config={blockchainDeveloperAcademyLandingPageConfig}
      blogs={blogs}
    />
  );
}
