...
In the [Avalanche Fundamentals course](/academy/avalanche-fundamentals), you learned how to quickly set up an L1 using the [Toolbox](https://build.avax.network/tools/l1-toolbox). This section provides an in depth review of that flow, understanding what comes pre-configured in our genesis, and laying the foundation for what we will need for our Permissioned L1.
...
3. Use the faucet button in this wallet component (below your C-chain balance) to claim test AVAX
...
Up next we will understand what is the starting point of our blockchain (*genesis.json*) and convert our Subnet to an L1.
