...
function ConsoleDashboard() {
  ...
  const primaryNetworks = [
    ...
    },
    {
      ...
      image:
        "https://images.ctfassets.net/gcj8jwzm6086/zDgUqvR4J10suTQcNZ3dU/842b9f276bef338e68cb5d9f119cf387/green-dot.png",
  ...
  const secondaryNetworks = [
    ...
    },
    {
      name: "KOROSHI Gaming",
      image:
        "https://images.ctfassets.net/gcj8jwzm6086/1cZxf8usDbuJng9iB3fkFd/1bc34bc28a2c825612eb697a4b72d29d/2025-03-30_07.28.32.jpg",
    ...
    },
    {
      name: "StraitsX",
      image:
        "https://images.ctfassets.net/gcj8jwzm6086/3jGGJxIwb3GjfSEJFXkpj9/2ea8ab14f7280153905a29bb91b59ccb/icon.png",
    ...
    },
    {
      name: "CX Chain",
      image:
        "https://images.ctfassets.net/gcj8jwzm6086/3wVuWA4oz9iMadkIpywUMM/377249d5b8243e4dfa3a426a1af5eaa5/14.png",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <Link href="/console/primary-network/node-setup" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Configure and deploy your Avalanche Primary Network node infrastructure
            </p>
        ...
        <Link href="/console/layer-1/create" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Launch your custom Layer 1 blockchain with custom configurations
            </p>
        ...
        <Link href="/console/permissioned-l1s/add-validator" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Add, remove, and configure validators for your L1 networks
            </p>
        ...
        <Link href="/console/icm/setup" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Enable communication between your L1s with Interchain Messaging
            </p>
        ...
        <Link href="/console/ictt/setup" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Configure token bridges for seamless cross-chain transfers
            </p>
        ...
        <Link href="/console/primary-network/faucet" className="group block">
          <div className="p-6 rounded-lg border bg-card hover:bg-accent/50 transition-all duration-200 cursor-pointer h-full">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Access the testnet faucet to get AVAX for development and testing
            </p>
