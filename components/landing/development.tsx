...
const development = [
  {
    ...
    description: "Find references for all Avalanche SDKs, APIs, and tools.",
    icon: Book,
    href: "/docs",
  },
  {
    ...
    description: "Leverage our Builder Console to launch your L1 blockchain.",
    icon: Wrench,
    href: "/console",
  },
  {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-4 mb-20" id="development">
      <div className="flex items-center justify-center gap-3 mb-4">
        <h2
          className="font-display text-3xl tracking-tight sm:text-5xl text-center font-bold
          ...
          {development.map((item, index) => (
            <Link
              ...
              className={cn(
                ...
                index === 1 &&
                  "lg:border-x-0 lg:border-l lg:border-r dark:lg:border-l-transparent dark:lg:border-r-transparent"
              )}
            >
              <div className="relative z-10 p-8 lg:p-10 h-full min-h-[280px] flex flex-col">
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div
                    className="p-3 rounded-xl bg-gray-100/80 dark:bg-[rgba(255,255,255,0.06)] 
                ...
                {/* CTA */}
                <div
                  className="mt-8 flex items-center text-gray-800 dark:text-slate-300 font-medium 
