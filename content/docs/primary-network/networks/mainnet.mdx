...
A _network of networks_, Avalanche Mainnet includes the [Primary Network](/docs/primary-network/overview) formed by the X, P, and C-Chain, as well as all in-production [Avalanche L1s](/docs/quick-start/avalanche-l1s).
