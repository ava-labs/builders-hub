            ...
            {data?.isContract && (data.contractMetadata?.deploymentDetails?.deployerAddress) && (
              <div className="mb-4">
                ...
                <div className="flex items-center gap-2 text-sm flex-wrap">
                  <Link 
                    href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, data.contractMetadata.deploymentDetails.deployerAddress)}
                  ...
                  {data.contractMetadata.deploymentDetails.txHash && (
                    <>
                      ...
                      <Link 
                        href={buildTxUrl(`/explorer/mainnet/${chainSlug}`, data.contractMetadata.deploymentDetails.txHash)}
                ...
                <div className="flex flex-wrap gap-2">
                  {data.addressChains.map((chain) => {
                    ...
                    const explorerUrl = chainInfo?.rpcUrl && chainSlug
                      ? `/explorer/mainnet/${chainSlug}/address/${address}`
                      : undefined;
                        ...
                        <tr key={tx.hash || index} className="border-b border-slate-100 dark:border-neutral-800 transition-colors hover:bg-blue-50/50 dark:hover:bg-neutral-800/50">
                          <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                            <div className="flex items-center gap-1.5">
                              <Link href={buildTxUrl(`/explorer/mainnet/${chainSlug}`, tx.hash)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(tx.hash)}</Link>
                          ...
                          <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                            <Link href={buildBlockUrl(`/explorer/mainnet/${chainSlug}`, tx.blockNumber)} className="text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{tx.blockNumber}</Link>
                          </td>
                          <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                            <div className="flex items-center gap-1.5">
                              <Link 
                  ...
                  <tbody className="bg-white dark:bg-neutral-950">
                    {data?.erc20Transfers?.map((transfer, index) => (
                      <tr key={`${transfer.txHash}-${transfer.logIndex}`} className="border-b border-slate-100 dark:border-neutral-800 transition-colors hover:bg-blue-50/50 dark:hover:bg-neutral-800/50">
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-1.5">
                            <Link href={buildTxUrl(`/explorer/mainnet/${chainSlug}`, transfer.txHash)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(transfer.txHash)}</Link>
                            <CopyButton text={transfer.txHash} />
                          </div>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <Link href={buildBlockUrl(`/explorer/mainnet/${chainSlug}`, transfer.blockNumber)} className="text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{transfer.blockNumber}</Link>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-1.5">
                            <Link href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, transfer.from)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(transfer.from)}</Link>
                            <CopyButton text={transfer.from} />
                          </div>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-1.5">
                            <Link href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, transfer.to)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(transfer.to)}</Link>
                        ...
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-2">
                            ...
                            <Link href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, transfer.tokenAddress)} className="text-sm hover:underline cursor-pointer text-neutral-900 dark:text-neutral-100">{transfer.tokenSymbol}</Link>
                          </div>
                        </td>
                  ...
                  <tbody className="bg-white dark:bg-neutral-950">
                    {data?.nftTransfers?.map((transfer, index) => (
                      <tr key={`${transfer.txHash}-${transfer.logIndex}`} className="border-b border-slate-100 dark:border-neutral-800 transition-colors hover:bg-blue-50/50 dark:hover:bg-neutral-800/50">
                        ...
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <Link href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, transfer.tokenAddress)} className="text-sm hover:underline cursor-pointer text-neutral-900 dark:text-neutral-100">{transfer.tokenName || transfer.tokenSymbol || 'Unknown'}</Link>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                  ...
                  <tbody className="bg-white dark:bg-neutral-950">
                    {data?.internalTransactions?.map((itx, index) => (
                      <tr key={`${itx.txHash}-${index}`} className="border-b border-slate-100 dark:border-neutral-800 transition-colors hover:bg-blue-50/50 dark:hover:bg-neutral-800/50">
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-1.5">
                            <Link href={buildTxUrl(`/explorer/mainnet/${chainSlug}`, itx.txHash)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(itx.txHash)}</Link>
                            <CopyButton text={itx.txHash} />
                          </div>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <Link href={buildBlockUrl(`/explorer/mainnet/${chainSlug}`, itx.blockNumber)} className="text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{itx.blockNumber}</Link>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-1.5">
                            <Link href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, itx.from)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(itx.from)}</Link>
                            <CopyButton text={itx.from} />
                          </div>
                        </td>
                        <td className="border-r border-slate-100 dark:border-neutral-800 px-4 py-2">
                          <div className="flex items-center gap-1.5">
                            <Link href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, itx.to)} className="font-mono text-sm hover:underline cursor-pointer" style={{ color: themeColor }}>{formatAddressShort(itx.to)}</Link>
                          ...
                          {sourcifyData.proxyResolution.implementations?.map((impl, idx) => (
                            <div key={idx} className="flex items-center gap-2 p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700">
                              ...
                              <div className="flex-1">
                                ...
                                <Link 
                                  href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, impl.address)} 
                            ...
                            <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                              ...
                              {sourcifyData.proxyResolution.implementations?.[0] && (
                                <span className="block mt-1">
                                  Implementation: 
                                  <Link
                                    href={buildAddressUrl(`/explorer/mainnet/${chainSlug}`, sourcifyData.proxyResolution.implementations[0].address)}
