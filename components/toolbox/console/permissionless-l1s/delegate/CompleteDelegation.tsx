...
interface CompleteDelegationProps {
    delegationID?: string;
...
const CompleteDelegation: React.FC<CompleteDelegationProps> = ({
    delegationID,
    ...
    const handleCompleteRegistration = async () => {
        ...
        try {
            // Call completeDelegatorRegistration with delegationID and messageIndex
            ...
            // Check for DelegatorRegistrationCompleted event
            ...
            if (message.includes('User rejected')) {
                ...
                message = 'Invalid delegation ID. The delegation may not have been initiated on the P-Chain yet.';
            ...
            setErrorState(`Failed to complete delegation: ${message}`);
            onError(`Failed to complete delegation: ${message}`);
        } finally {
        ...
        <div className="space-y-4">
            ...
            <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
                <h3 className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-3">
                    Complete Delegation ({tokenLabel} Staking)
                </h3>
                ...
                <div className="space-y-3">
                    ...
                    <Input
                        ...
                        helperText="Index of the warp message from P-Chain delegation (usually 0)"
                    />
                </div>
            </div>
            ...
            <Alert variant="info">
                <p className="text-sm">
                    <strong>Before completing delegation:</strong>
                </p>
                <ul className="list-disc list-inside text-sm mt-2 space-y-1">
                    <li>Ensure the P-Chain delegation transaction has been confirmed</li>
                    <li>The warp message from the P-Chain must be available</li>
                    <li>Once completed, your delegation will be active on the validator</li>
            ...
            >
                {isProcessing ? 'Processing...' : 'Complete Delegation'}
            </Button>
                    ...
                    {registrationComplete && (
                        <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-md">
                            <p className="text-sm text-green-800 dark:text-green-200">
                                <strong>Success!</strong> Your delegation is now active. You will earn rewards based on the validator's performance.
                            </p>
                        </div>
                    )}
                </>
            ...
            <Alert variant="warning">
                <p className="text-sm">
                    <strong>Important:</strong> After completing delegation, the validator's weight on the P-Chain will be updated.
                    Your delegation rewards will accrue based on the validator's performance and uptime.
                </p>
            </Alert>
        </div>
    );
...
export default CompleteDelegation;
