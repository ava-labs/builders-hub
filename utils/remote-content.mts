...
async function main(): Promise<void> {
  ...
  const allSections = [
    { name: 'Cross-Chain', configs: await getCrossChainConfigs() },
    { name: 'APIs', configs: await getApisConfigs() },
    { name: 'Primary Network', configs: await getPrimaryNetworkConfigs() },
    { name: 'Avalanche L1s', configs: await getAvalancheL1sConfigs() },
