  ...
  return (
    <div className="space-y-6">
        ...
        <Step>
          ...
          {validatorSelection.nodeId && (
            <div className="mt-3 bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
              ...
              <p className="text-sm font-mono text-green-900 dark:text-green-100 mt-1">{validatorSelection.nodeId}</p>
            </div>
          )}
        </Step>
      ...
      <StepFlowFooter
        ...
        showReset={
          !!(initiateDelegationTxHash || pChainTxId || completeDelegationTxHash || globalError || globalSuccess)
        }
        onReset={handleReset}
      />
    </div>
