export const t = {
  en: {
    ...
    trackDescription:
      'Type a detailed description of the track. You can use HTML tags like <b></b>, <a href=""></a>, etc.',
  ...
  es: {
    ...
    trackDescription:
      'Escribe una descripción detallada del track. Puedes usar etiquetas HTML como <b></b>, <a href=""></a>, etc.',
    ...
    schedule: "Agenda",
    scheduleHelp:
      "Agendas del hackathon como Formación de Equipos, Taller: Dominando Avalanche, etc.",
    ...
    judgingGuidelinesHelp:
      "Escribe los criterios de evaluación. Nota: Puedes usar etiquetas como <h3></h3>, /n, etc.",
