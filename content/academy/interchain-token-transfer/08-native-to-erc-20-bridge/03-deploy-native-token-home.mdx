...
```bash
forge create --rpc-url myblockchain --private-key $PK lib/ictt/contracts/src/TokenHome/NativeTokenHome.sol:NativeTokenHome --constructor-args $TELEPORTER_REGISTRY_L1 $FUNDED_ADDRESS $WRAPPED_ERC20_L1 --broadcast
```
```
[⠊] Compiling...
