...
export default function PChainDelegationWeightUpdateStep() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
      ...
      <StepCodeViewer activeStep={1} steps={DELEGATION_REMOVAL_STEPS} className="lg:sticky lg:top-4 lg:self-start" />
    </div>
  );
}
