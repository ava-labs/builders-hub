...
const generateCheckNodeCommand = (
  chainId: string,
  domain: string,
  isDebugTrace: boolean = false
) => {
  let baseUrl;
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-4">
        <div className="space-y-4">
          <p>
            During the bootstrapping process, the following command will return a 404 page not found
            error:
          </p>
          ...
          <p>
            Once bootstrapping is complete, it will return a response like{" "}
            <code>{'{"jsonrpc":"2.0","id":1,"result":"..."}'}</code>.
          </p>
        </div>
      ...
      {bootstrapChecked && isDebugTrace && (
        <div className="space-y-4 mt-6">
          ...
          <p>
            Make sure you make at least one transaction on your chain, or it will error
            &quot;genesis is untracable&quot;.
          </p>
        </div>
      )}
