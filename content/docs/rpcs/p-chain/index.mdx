...
The P-Chain API allows clients to interact with the [P-Chain](https://build.avax.network/docs/primary-network#p-chain), which maintains Avalanche’s validator set and handles blockchain creation.
