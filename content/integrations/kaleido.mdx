...
Kaleido is an enterprise blockchain platform with support for [Avalanche nodes and subnets](https://www.kaleido.io/avalanche). It provides 500+ pluggable Web3 tools for building dApps with fast finality and high throughput.

Rated #1 for Asset Tokenization and Blockchain-as-a-Service on G2, Kaleido is used by organizations including Swift, Unionbank of the Philippines, and the Reserve Bank of Australia.
...
For more details, visit the [Kaleido Documentation](https://docs.kaleido.io/).
...
- **NFT Platforms**: Use Avalanche's speed and security to manage NFTs at scale
