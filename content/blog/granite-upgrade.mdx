...
A [pre-release](https://github.com/ava-labs/avalanchego/releases/tag/v1.14.0-fuji) for the latest upgrade to the Avalanche Network, dubbed "Avalanche Granite", was published on **October 21st, 2025** and successfully activated on the **Fuji Testnet at 11 AM ET (3 PM UTC) on Wednesday, October 29th, 2025**. The Avalanche Mainnet release is scheduled to be published on **November 5th, 2025**, with activation scheduled for **November 19th, 2025 at 11 AM ET (3 PM UTC)**.
