...
function DeployNativeTokenRemote() {
  ...
  const [burnedFeesReportingRewardPercentage, setBurnedFeesReportingRewardPercentage] =
    useState("0");
    ...
    >
      <div>
        <p className="mt-2">
          ...
          This contract acts as the bridge endpoint for your native token from the source chain. To
          mint native tokens, please use the{" "}
          <a
      ...
      >
        <p>
          ...
          <strong>destination chain</strong> (where you want to receive bridged tokens as native
          currency).
        </p>
