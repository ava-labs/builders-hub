 ...
 */
export function useNativeTokenStakingManager(contractAddress: string | null, abi?: any): NativeTokenStakingManagerHook {
  ...
  const completeValidatorRegistration = (messageIndex: number, accessList?: any[]) =>
    contract.write(
      ...
      [messageIndex],
      'Complete Validator Registration (Native Staking)',
      { accessList },
    );
  ...
  const initiateDelegatorRegistration = (validationID: string, rewardRecipient: string, delegationAmount: bigint) =>
    contract.write(
      ...
      'Initiate Delegator Registration (Native Staking)',
  ...
  const completeDelegatorRegistration = (messageIndex: number, delegationID: string, accessList?: any[]) =>
    contract.write(
      ...
      'Complete Delegator Registration (Native Staking)',
      { accessList },
    );
  ...
  const completeDelegatorRemoval = (delegationID: string, messageIndex: number, accessList?: any[]) =>
    contract.write(
      ...
      'Complete Delegator Removal (Native Staking)',
      { accessList },
    );
  ...
  const forceInitiateDelegatorRemoval = (delegationID: string, includeUptime: boolean, messageIndex: number) =>
    contract.write(
      ...
      'Force Initiate Delegator Removal (Native Staking)',
    );
