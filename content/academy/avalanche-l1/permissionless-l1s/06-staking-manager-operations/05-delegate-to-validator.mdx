...
The delegator calls [`initiateDelegatorRegistration`](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/NativeTokenStakingManager.sol) on the Staking Manager contract:
...
Call [`completeDelegatorRegistration(messageIndex)`](https://github.com/ava-labs/icm-contracts/blob/main/contracts/validator-manager/PoSValidatorManager.sol) with the P-Chain's signed response:
