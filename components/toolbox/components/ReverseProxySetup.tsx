  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p>
          To connect your wallet you need to be able to connect to the RPC via https. For testing
          purposes you can set up a reverse Proxy to achieve this.
        </p>
      ...
      {domain && showHealthCheck && (
        <div>
          ...
          <p>
            Do a final check from a machine different than the one that your node is running on.
          </p>

          <div className="space-y-6 mt-4">
            <DynamicCodeBlock lang="bash" code={generateHealthCheckCommand(domain, chainId)} />

            <HealthCheckButton chainId={chainId} domain={domain} />
          </div>
        </div>
      )}
    </div>
