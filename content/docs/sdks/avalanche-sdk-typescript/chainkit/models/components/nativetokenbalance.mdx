...
description: "Chainkit SDK documentation for native token balance"
edit_url: https://github.com/ava-labs/avalanche-sdk-typescript/edit/main/chainkit/docs/models/components/nativetokenbalance.md
---
...
```typescript
import { NativeTokenBalance } from "@avalanche-sdk/chainkit/models/components";
...
| `balanceValue`                                                                                                                        | [components.Money](https://github.com/ava-labs/avalanche-sdk-typescript/blob/main/chainkit/models/components/money.md)                                                                                  | :heavy_minus_sign:                                                                                                                    | The monetary value of the balance, if a price is available for the token.                                                             |                                                                                                                                       |