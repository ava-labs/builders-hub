...
export const steps: StepDefinition[] = [
    ...
    { type: "single", key: "deploy-example-reward-calculator", title: "Deploy Example Reward Calculator", component: DeployExampleRewardCalculator },
    {
        ...
        title: "Initialize ERC20 Staking Manager",
        component: InitializeERC20StakingManager,
    },
    { type: "single", key: "enable-erc20-staking-minting", title: "Enable ERC20 StakingManager Minting", component: EnableERC20StakingManagerMinting },
