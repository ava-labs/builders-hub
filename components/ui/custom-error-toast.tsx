...
export const CustomErrorToast: React.FC<CustomErrorToastProps> = ({
  message,
  toastId,
  maxLength = 220,
}) => {
  ...
  const displayMessage =
    isExpanded || !shouldTruncate ? message : message.substring(0, maxLength) + "...";
  ...
  useEffect(() => {
    if (isExpanded && wasExpandedRef.current) {
      toast.custom(
        (t) => <CustomErrorToast message={message} toastId={t} maxLength={maxLength} />,
        {
          id: toastId,
          duration: Infinity,
        }
