...
- We use proxy as predeployed contract to make `convertSubnetToL1` work smoothly, since the txn capacity of this operation is limited, we benefit from already including the data to deploy this before in the *genesis.json*
