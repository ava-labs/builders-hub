...
For Subnet-EVM's [fee manager precompile](https://build.avax.network/docs/avalanche-l1s/evm-configuration/transaction-fees#fee-manager) these fields are deprecated by ACP-226 and no longer effective:
...
There is no action required. These fields will be ignored by the fee manager precompile.
