...
```bash
forge create --rpc-url local-c --private-key $PK lib/ictt/contracts/src/TokenHome/ERC20TokenHome.sol:ERC20TokenHome --optimize --optimizer-runs 200 --broadcast --constructor-args $TELEPORTER_REGISTRY_C_CHAIN $FUNDED_ADDRESS $ERC20_C_CHAIN 18
```
