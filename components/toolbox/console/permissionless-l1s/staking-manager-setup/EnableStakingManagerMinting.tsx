      ...
      <div className="flex-1 overflow-auto p-5 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                ...
                The ERC20 token must implement the <code className="text-blue-800 dark:text-blue-200">IERC20Mintable</code> interface and grant minting permissions to the staking manager.
              </p>
                  ...
                  <div>
                    ...
                    {erc20StakingManagerAddress && (
                      <p className="mt-2 text-xs text-amber-600 dark:text-amber-400">
                        <span className="font-medium">Note:</span> If your token only allows the owner to mint, transfer ownership to{" "}
              ...
              <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ol className="list-decimal list-inside text-xs text-amber-700 dark:text-amber-300 space-y-1">
                      <li>Implement the <code className="text-amber-800 dark:text-amber-200">IERC20Mintable</code> interface with a <code className="text-amber-800 dark:text-amber-200">mint(address, uint256)</code> function</li>
        ...
        <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700">
          ...
          <ol className="list-decimal list-inside text-xs text-zinc-600 dark:text-zinc-400 space-y-1">
            ...
            <li>The token implements <code className="text-zinc-700 dark:text-zinc-300">IERC20Mintable</code> interface</li>
