...
const metadata: ConsoleToolMetadata = {
  ...
  description: "Deploy an ERC20 token with AccessControl for staking. The deployer receives MINTER_ROLE and can grant it to the Staking Manager.",
  toolRequirements: [
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-zinc-600 dark:text-zinc-400">
        This deploys an ERC20 token with <strong>OpenZeppelin AccessControl</strong> on
        your connected network (Chain ID: <code>{walletChainId}</code>).
        The deployer receives the <code>MINTER_ROLE</code> and <code>DEFAULT_ADMIN_ROLE</code>,
        with 10M tokens minted to your wallet. You must grant <code>MINTER_ROLE</code> to the
        Staking Manager in the next step for reward minting to work.
      </div>
