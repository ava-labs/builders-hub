...
**Note:** The sherry.social website and documentation site appear to be experiencing downtime as of March 2026. The project's source code remains available on [GitHub](https://github.com/SherryLabs).
...
For guides and technical documentation, visit [Sherry Documentation](https://docs.sherry.social/docs/intro). Key resources include:
...
- **Cross-Chain Operations**: Execute asset transfers between different blockchain networks.
...
Additional L1 chains are being added over time.

## Recent Milestones

**Avalanche Codebase (discontinued)**: Part of Avalanche Codebase S25.
