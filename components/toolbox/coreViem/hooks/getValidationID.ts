 ...
 */
export async function getValidationIdHex(
  ...
  try {
    ...
    throw new Error(
      `Both getNodeValidationID and registeredValidators failed. NodeID: ${nodeID}. The contract might not have either function or the nodeID format is incorrect.`
    );
  }
}
