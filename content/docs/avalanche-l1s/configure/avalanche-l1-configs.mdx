...
[here](https://build.avax.network/docs/primary-network/configure/configs-flags#subnet-configs).
...
same values used for the Primary Network, which are given [CLI Snow Parameters](https://build.avax.network/docs/primary-network/configure/configs-flags#snow-parameters).
...
see [CLI Gossip Configs](https://build.avax.network/docs/primary-network/configure/configs-flags#gossiping).
