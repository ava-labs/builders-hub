...
In order to fully understand these operations, it is a good reminder to see this diagram again, from the [ICM for Validator Manager Contracts](/academy/permissioned-l1s/01-introduction/03-interop), as we will dive deep into why and how these communication flows actually work/
